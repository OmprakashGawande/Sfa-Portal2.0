                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    <asp:TextBox ID="txtOrderDate" runat="server" placeholder="Select Date..." class="form-control DateAdd" data-date-start-date="-30d" autocomplete="off" onpaste="return false" ClientIDMode="Static"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    <asp:TextBox ID="txtEffectiveDate" runat="server" placeholder="Select Effective Date..." class="form-control DateAdd" autocomplete="off" onpaste="return false" ClientIDMode="Static" data-date-start-date="-30d"></asp:TextBox>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="table table-responsive">
                                <asp:GridView ID="GridView1" runat="server" class="table table-hover table-bordered table-striped pagination-ys" AutoGenerateColumns="False" AllowPaging="True" DataKeyNames="PromotionID" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" OnRowDeleting="GridView1_RowDeleting">
                                    <Columns>
    ...
    <script type="text/javascript">
        ...
        $('#txtOrderDate').change(function () {
            ...
            if ($('#txtEffectiveDate').val() != "") {
                if (start > end) {
                    ...
                    if ($('#txtOrderDate').val() != "") {
                        alert("Order date can not be less than Effective Date.");
                        $('#txtOrderDate').val("");
                    }
                }
            }
        ...
        $('#txtEffectiveDate').change(function () {
            ...
            if (start > end) {
                ...
                if ($('#txtEffectiveDate').val() != "") {
                    alert("Effective Date can not be greater than Order Date.");
