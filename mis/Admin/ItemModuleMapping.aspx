<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="ItemModuleMapping.aspx.cs" Inherits="mis_Masters_ItemModuleMapping" %>
            ...
            <section class="container-fluid">
                <div class="box">
                    <div class="box-body">
                        ...
                        <div class="card">
                            <div class="card card-header">Item Module Mapping</div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <asp:Label runat="server">Module Name<span class="text-danger">*</span></asp:Label>
                                            <asp:DropDownList ID="ddlModule" runat="server" CssClass="form-control select2"></asp:DropDownList>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ValidationGroup="Save"
                                                            ErrorMessage="Select Module Name" InitialValue="0" ForeColor="Red" Text="<i class='fa fa-exclamation-circle' title='Select Module Name!'></i>"
                                                            ControlToValidate="ddlModule" Display="Dynamic" runat="server">
                                                        </asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                ...
                                <div class="row" id="dv" runat="server" visible="false">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="table-responsive">
                                            <asp:CheckBoxList ID="chkAllItem" CssClass="table District customCSS" runat="server" RepeatColumns="5" RepeatDirection="Horizontal" ClientIDMode="Static"></asp:CheckBoxList>
                                        </div>
                                            <div class="col-md-3">
                                                <div class="form-group" style="padding-top: 25px">
     ...
     <script type="text/javascript">
         ...
         function CheckAllItem() {
             if (document.getElementById('<%=chkAll.ClientID%>').checked == true) {
                  ...
                  var chkOfficeAll = document.getElementById('<%=chkAllItem.ClientID%>');
