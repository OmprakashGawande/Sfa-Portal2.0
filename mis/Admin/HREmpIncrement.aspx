                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddlOldLevel" runat="server" class="form-control" Enabled="true"></asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>मूल वेतन / Basic Salary<span style="color: red;">*</span></label>
                                            <asp:TextBox ID="txtOldBasicSalary" runat="server" placeholder="Enter Basic Salary..." class="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </fieldset>
