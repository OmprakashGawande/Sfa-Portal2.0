                                ...
                                <asp:GridView ID="GridView1" runat="server" class="datatable table table-hover table-bordered table-striped pagination-ys" AutoGenerateColumns="False" ShowHeaderWhenEmpty="true"  EmptyDataText="No Record Found">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Documents">
                                            <ItemTemplate>
                                                <asp:HyperLink ID="Documents" runat="server" CssClass="btn btn-xs btn-info btn-flat" Text="View Document" Visible='<%#Eval("Documents").ToString()!= "" ? true : false %>' Target="_blank" NavigateUrl='<%# "~/mis/HR/" + Eval("Documents") %>'> 
