                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtItem_Category" runat="server" placeholder="Item Group..." class="form-control" MaxLength="100" onkeypress="javascript:tbx_fnAlphaOnly(event, this);"></asp:TextBox>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Action" ShowHeader="False">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:LinkButton ID="Delete" runat="server" CssClass="label label-danger" CausesValidation="False" CommandName="Delete" Text="Delete" OnClientClick="return confirm('Item Group will be deleted. Are you sure want to continue?');"></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
    ...
    <script type="text/javascript">
        function validateform() {
            ...
            if (document.getElementById('<%=txtItem_Category.ClientID%>').value.trim() == "") {
                ...
                $("#valtxtItem_Category").html("Enter Item Group");
            }
            if (msg != "") {
                alert(msg);
                return false;
