...
public partial class mis_Payroll_PayrollEDLIRenewReport : System.Web.UI.Page
{
    ...
    protected void FillGrid()
    {
        try
        {
            ...
            GridView1.DataBind();
            ds = objdb.ByProcedure("SpPayrollEpfDedMonthWise", new string[] { "flag", "Year", "SalaryMonth", "SalaryYear", "DaPercentage" }, new string[] { "11", ddlYear.SelectedValue.ToString(), ddlMonth.SelectedValue.ToString(), ddlsalaryyear.SelectedValue.ToString(),txtDaPercentage.Text.ToString() }, "dataset");
