    ...
    protected void FillGrid()
    {
        try
        {
            ...
            if (ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                ...
                lblSelectedItems.Text = "Attendance of office <b>" + ddlOfficeName.SelectedItem.ToString() + "</b> from 21/" + startDateMonth + "/" + startDateYear + " To 20/" + ddlMonth.SelectedValue.ToString() + "/" + ddlYear.SelectedValue.ToString() + "  ( " + ddlEmp_TypeOfPost.SelectedItem.ToString() + " )";
            ...
            lblNotify.Text = "<br/>Note :- Set Attendance from 21/" + startDateMonth + "/" + startDateYear + " To 20/" + ddlMonth.SelectedValue.ToString() + "/" + ddlYear.SelectedValue.ToString();
        }
        catch (Exception ex)
        {
            lblMsg.Text = objdb.Alert("fa-ban", "alert-danger", "Sorry!", ex.Message.ToString());
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ddlYear.SelectedIndex > 0 && ddlOfficeName.SelectedIndex > 0 && ddlMonth.SelectedIndex > 0)
            {
                ...
                if (S_Year > 2021)
                {
                    msg += "User can't search data after August, 2021.";
                }
                else if (S_Year == 2021)
                {
                    if (S_Month >= 9)
