...
public partial class mis_Payroll_PayrollEmpSetAttendance26_25 : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void FillGrid()
    {
        try
        {
            ...
            if (ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                ...
                lblSelectedItems.Text = "Attendance of office <b>" + ddlOfficeName.SelectedItem.ToString() + "</b> from 26/" + startDateMonth + "/" + startDateYear + " To 25/" + ddlMonth.SelectedValue.ToString() + "/" + ddlYear.SelectedValue.ToString() + "  ( " + ddlEmp_TypeOfPost.SelectedItem.ToString() + " )";
            ...
            lblNotify.Text = "<br/>Note :- Set Attendance from 26/" + startDateMonth + "/" + startDateYear + " To 25/" + ddlMonth.SelectedValue.ToString() + "/" + ddlYear.SelectedValue.ToString();
        }
        catch (Exception ex)
        {
            lblMsg.Text = objdb.Alert("fa-ban", "alert-danger", "Sorry!", ex.Message.ToString());
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                string msg = "";
                int S_Year = int.Parse(ddlYear.SelectedValue.ToString());
                int S_Month = int.Parse(ddlMonth.SelectedValue.ToString());
                if(S_Year < 2021)
                {
                    msg += "User can't search data before September, 2021.";
                }
                else if (S_Year == 2021)
                {
                    if (S_Month < 9)
                ...
                else
                {
                   // Page.ClientScript.RegisterStartupScript(this.GetType(), "CallMyFunction", "alert('" + msg + "');", true);
                    lblMsg.Text = objdb.Alert("fa-info", "alert-info", "Sorry!", msg.ToString());
                }
            }
