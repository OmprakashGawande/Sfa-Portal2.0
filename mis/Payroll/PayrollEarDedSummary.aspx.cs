    ...
    protected void FillDetail()
    {
        try
        {
            ...
            ds = objdb.ByProcedure("SpPayrollSalaryFinalSummary",
                new string[] { "flag", "Office_ID", "Year", "MonthNo", "Emp_TypeOfPost" },
                new string[] { "0", ddlOffice.SelectedValue.ToString(), 
                               ddlFinancialYear.SelectedValue.ToString(), 
                               ddlMonth.SelectedValue.ToString(),ddlEmp_TypeOfPost.SelectedValue }, "dataset");
