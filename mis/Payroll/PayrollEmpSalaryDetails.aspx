                ...
                <div class="box-body">
                    ...
                    <div id="DivDetail" runat="server">
                                        ...
                                        <Columns>
                                            <asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <asp:CheckBox ID="chkSelect" runat="server" Checked="true" Enabled='<%# Eval("GenStatus").ToString() == "Not Generated" ? true : false %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <asp:Button ID="btnHold" CssClass="btn btn-block btn-warning" OnClick="btnHold_Click" runat="server" Text="Hold" />
                            </div>
                            <%--                            <div class="col-md-2">
