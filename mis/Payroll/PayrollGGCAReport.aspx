                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtDaPercentage" required MaxLength="3" class="form-control" runat="server" onkeypress="return validateNum(event);"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
