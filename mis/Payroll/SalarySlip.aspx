        ...
        <div class="container">
            <div class="content-wrapper">
               <%-- <section class="content watermark" id="DivSlip" runat="server" style="padding-top: 0px; height: 60px;">--%>
                 <section class="content" id="DivSlip" runat="server" style="padding-top: 0px; height: 60px;">
                    <!-- Default box -->
                    <div class="box box-default">
                        <div class="box-header text-center">
                            <h3 class="">
                                <%--<img src="../image/mpagro-logo.png" class="salary-logo">--%>
                                &nbsp;&nbsp;SFA Technologies Pvt. Ltd. SFA Tower 28-Sector A, Kasturba Nagar, Chetak Bridge, Bhopal - 462023, India
							<br>
