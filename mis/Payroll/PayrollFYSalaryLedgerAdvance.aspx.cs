...
public partial class mis_Payroll_PayrollFYSalaryLedgerAdvance : System.Web.UI.Page
{
    ...
    protected void FillGrid()
    {
        try
        {
            ...
            GridView1.DataBind();
            //string selectedEmpDetail = "<div class='row'><div class='col-md-12'><div class='text-center'><img  style='max-width:60px;' src='../image/mpagro-logo.png' class='salary-logo'><br></div></div></div>";
            string selectedEmpDetail = "<div class='row'><div class='col-md-12'><div class='text-center'><br></div></div></div>";
            // selectedEmpDetail += "<div class='row'><div class='col-md-12'><p style='text-align: center; font-size:14px;'>मध्य प्रदेश स्टेट एग्रो इंडस्ट्रीज डेवलपमेंट कारपोरेशन लिमिटेड<br>(मध्य प्रदेश शासन का उपक्रम)<br>पंचानन भवन, तृतीय तल, मालवीय नगर भोपाल<br>Phone(0755) - 2552652,2551756,2551807 Fax: 0755-2557305</p></div></div>";
            selectedEmpDetail += "<div class='row'><div class='col-md-12'><p style='text-align: center; font-size:14px;'>SFA Technologies Pvt. Ltd.</p></div></div>";
