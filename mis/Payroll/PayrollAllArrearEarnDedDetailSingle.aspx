<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="PayrollAllArrearEarnDedDetailSingle.aspx.cs" Inherits="mis_Payroll_PayrollAllArrearEarnDedDetailSingle" %>
        ...
        <section class="content">
            <div class="box box-success">
                <div class="box-header Hiderow">
                    <h3 class="box-title">Arrear Earning Deduction Details (Single Employee)</h3>
                    ...
                    <div class="row Hiderow">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <asp:DropDownList runat="server" ID="ddlOffice" CssClass="form-control" ClientIDMode="Static" AutoPostBack="true" OnSelectedIndexChanged="ddlOfficeName_SelectedIndexChanged">
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlEmployee" runat="server" CssClass="form-control select2" ClientIDMode="Static">
                                </asp:DropDownList>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div runat="server" id="DivHead" style="text-align: center;">
                                <h5>SFA Technologies Pvt. Ltd.    SFA Tower 28-Sector A, Kasturba Nagar, Chetak Bridge, Bhopal - 462023, India</h5>
