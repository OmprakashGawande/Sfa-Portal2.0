...
public partial class mis_Payroll_PayrollAllArrearEarnDedDetailSingle : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void FillSalary()
    {
        try
        {
            ...
            string Salary_Employee = ddlEmployee.SelectedValue.ToString();

            lblSession.Text = ddlMonth.SelectedItem.ToString() + " " + ddlFinancialYear.SelectedValue.ToString();
            DivHead.Visible = true;
            ds = objdb.ByProcedure("SpPayrollEmpArrear", new string[] { "flag", "Office_ID", "CurrentYear", "CurrentMonth", "Emp_ID" }, new string[] { "51", Office_ID, Salary_Year, Salary_MonthNo, Salary_Employee }, "dataset");
