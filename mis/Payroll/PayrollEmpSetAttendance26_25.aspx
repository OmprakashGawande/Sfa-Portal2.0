<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="PayrollEmpSetAttendance26_25.aspx.cs" Inherits="mis_Payroll_PayrollEmpSetAttendance26_25" %>
            ...
            <div class="box box-success" style="min-height: 500px;">
                <div class="box-header">
                    <h3 class="box-title print_hidden">Employee Attendance</h3>
                     <span  class="print_hidden" style="font-weight:600; color:red;">[User can't search data before September, 2021.]</span>
                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <p style="text-align: left;">
                                                <asp:Label ID="lblSelectedItems" runat="server" Text=""></asp:Label></p>
                                        </div>

                                        <div class="col-md-6">
                                            <p style="text-align: right;">
                                                Date :  <asp:Label ID="lblAttDate" runat="server" Text=""></asp:Label>
                                            </p>
                                        </div>
                                    </div>
                                </div>
