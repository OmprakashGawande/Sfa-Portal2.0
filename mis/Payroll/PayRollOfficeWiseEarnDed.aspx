<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="PayRollOfficeWiseEarnDed.aspx.cs" Inherits="mis_Payroll_PayRollOfficeWiseEarnDed" %>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-success">
                        <div class="box-header with-border">
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    <h3 class="box-title" id="Label1">Monthly Office Wise Single Head Report</h3>
                                </div>
    ...
    <script>
        ...
        function validateform() {
            ...
            if (document.getElementById('<%=ddlEarnDeducHead.ClientID%>').selectedIndex == 0) {
                ...
                $("#valddlEarnDeducHead").html("Select Earning Deduction Head.");
            }
