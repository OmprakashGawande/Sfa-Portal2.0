        ...
        if (!IsPostBack)
        {
            if (Session["Emp_ID"] != null)
            {
                if (Request.QueryString["Year"] != null && Request.QueryString["Month"] != null && Request.QueryString["EmpType"] != null)
                {
					...
					else if (ViewState["EmpType"].ToString() == "DeputationEmployee")
                    {
                        ViewState["EmpType"] = "Deputation Employee";
                    }
                    else
                    {
                ...
                if (ds.Tables[0].Rows.Count != 0)
                {
                    ...
                    for (int i = 0; i < Count; i++)
                    {
                        ...
                        if (ds1.Tables[0].Rows.Count != 0)
                        {
                            ...
                            sb.Append("&nbsp;&nbsp; SFA Technologies Pvt. Ltd.<br/> SFA Tower 28-Sector A, Kasturba Nagar, Chetak Bridge, Bhopal - 462023, India<br>");
                            ...
                            sb.Append("<th style='width: 84px !important;'>UAN:</th>");
                            ...
                            sb.Append("<tr>");
                            sb.Append("<th>EMPCODE/EPF:</th>");
                            sb.Append("<td style='text-align:left;'>" + ds1.Tables[0].Rows[0]["UserName"].ToString() + " / " + ds1.Tables[0].Rows[0]["EPF_No"].ToString() + "</td>");
                            ...
                            sb.Append("<div class=''>");
                            sb.Append("<div class='' style='padding-bottom: 0; padding-left: 5px; font-weight: 700;'>");
                            sb.Append("<h4 style='margin-bottom: 3px;'>DEDUCTIONS <b>[TOTAL LEAVE DAYS " + ds1.Tables[0].Rows[0]["LeaveDays"].ToString() + "]</b></h4>");
                            sb.Append("</div>");
                            sb.Append("<div class=''>");
                            sb.Append("<div class='table-responsive'>");
                            sb.Append("<div>");
