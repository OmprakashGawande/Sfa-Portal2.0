<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="DateWise_Task_Status_Rpt.aspx.cs" Inherits="mis_Daily_Task_DateWise_Task_Status_Rpt" %>
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class=" col-md-3" runat="server">
                                <label runat="server">EMPLOYEE NAME
                                    <label style="color: red;">*</label></label>
                            ...
                            <div class="col-md-3" style="margin-top: 26px">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <a href="DateWise_Task_Status_Rpt.aspx" class="btn btn-block btn-default">Clear</a>
                                    </div>
                                </div>
                            </div>
                        </div>
