...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="Server">
                        ...
                        <div>                       
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-sm-6 position-relative">
                                    <div class="form-group">
                                        ...
                                        <label style="color: red;">*</label>
                                        <asp:TextBox runat="server" ID="txtEmp" CssClass="form-control" disabled="disabled">
                            ...
                            <div class="row">
                                <div class="table-responsive">
                                    <div class="col-md-12">
                                        <asp:GridView ID="Grid" PageSize="50" runat="server" class="datatable display  table table-hover table-bordered pagination-ys" OnRowDataBound="Grid_RowDataBound" ShowHeaderWhenEmpty="true" AutoGenerateColumns="False" OnRowCommand="Grid_RowCommand">
                                            <Columns>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myLargeAddModuleModel">Fill Report</h4>
                    <button class="btn-close py-0" type="button" onclick="closePopup('#exampleModal')"></button>
                </div>
                <div class="modal-body dark-modal">

                    <div class="card fa-border">
                        <asp:Label runat="server" ID="lblmsgErr" Text=""></asp:Label>
                        <div class="card-body ">
                            <!-- Modal Body -->
                                ...
                                <div class="row mt-2">
                                    <div class="col-xl-6 col-sm-6  position-relative"">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" disabled="disabled" rows="2" id="lblTaskDetails" runat="server"></textarea>
                                    ...
                                    <div class="col-xl-6 col-sm-6  position-relative"">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" disabled="disabled" rows="2" id="lblTaskDiscreiptionData" runat="server"></textarea>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3 col-sm-6 position-relative">
                                            <div class="form-group">
                                                ...
                                                <asp:DropDownList runat="server" ID="ddlWorkingStatus" CssClass="form-control select2">
                                                    <asp:ListItem Value="0">Select</asp:ListItem>
    ...
    <script>
        ...
        element.addEventListener("keyup", (event) => CharactersCount(500));
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentFooter" runat="Server">
    <script>
        $(document).ready(function () {
            $(document).ready(function () {
                initCustomDataTable('.datatable', 'Daily Task Status Entry', 'Daily Task Status Entry Data');
            });
