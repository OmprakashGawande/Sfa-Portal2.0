                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <asp:Button ID="btnPromotion" CssClass="btn btn-block btn-success" Style="margin-top: 23px;" runat="server" Text="Approve" OnClientClick="return validateform()();" OnClick="btnPromotion_Click" />
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
