                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-12 ">
                                    <div class="box-tools pull-right">
                                        <label class="box-tools">Filter : </label>
                                        <asp:DropDownList ID="ddlAdminOffice_ID" runat="server" OnInit="ddlAdminOffice_ID_Init" CssClass="form-control select2 box-tool margin " OnSelectedIndexChanged="ddlAdminOffice_ID_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                        </div>
