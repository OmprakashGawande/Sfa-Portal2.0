...
public partial class mis_HR_HREmpDetailOfficeWise : System.Web.UI.Page
{
    ...
    protected void FillPersonalDetail()
    {
        try
        {
            ...
            if (ddlEmp_Relation.Items.FindByValue(dsRecord.Tables[0].Rows[0]["Emp_Relation"].ToString()) != null)
            {
                ddlEmp_Relation.Items.FindByValue(dsRecord.Tables[0].Rows[0]["Emp_Relation"].ToString()).Selected = true;
            }
            txtEmp_FatherHusbandName.Text = dsRecord.Tables[0].Rows[0]["Emp_FatherHusbandName"].ToString();
            ddlEmp_Gender.ClearSelection();
            if (ddlEmp_Gender.Items.FindByValue(dsRecord.Tables[0].Rows[0]["Emp_Gender"].ToString()) != null)
            {
                ddlEmp_Gender.Items.FindByValue(dsRecord.Tables[0].Rows[0]["Emp_Gender"].ToString()).Selected = true;
            }
            ddlEmp_BloodGroup.ClearSelection();
            if (ddlEmp_BloodGroup.Items.FindByText(dsRecord.Tables[0].Rows[0]["Emp_BloodGroup"].ToString()) != null)
            {
            ...
            if (ddlEmp_MaritalStatus.Items.FindByText(dsRecord.Tables[0].Rows[0]["Emp_MaritalStatus"].ToString()) != null)
            {
            ...
            if (ddlEmp_Category.Items.FindByText(dsRecord.Tables[0].Rows[0]["Emp_Category"].ToString()) != null)
            {
            ...
            if (ddlEmp_Religion.Items.FindByText(dsRecord.Tables[0].Rows[0]["Emp_Religion"].ToString()) != null)
            {
            ...
            if (rbtEmp_Disability.Items.FindByValue(dsRecord.Tables[0].Rows[0]["Emp_Disability"].ToString()) != null)
            {
                rbtEmp_Disability.Items.FindByValue(dsRecord.Tables[0].Rows[0]["Emp_Disability"].ToString()).Selected = true;
            }
            ddlEmp_DisabilityType.ClearSelection();
            if (ddlEmp_DisabilityType.Items.FindByValue(dsRecord.Tables[0].Rows[0]["Emp_DisabilityType"].ToString()) != null)
            {
                ddlEmp_DisabilityType.Items.FindByValue(dsRecord.Tables[0].Rows[0]["Emp_DisabilityType"].ToString()).Selected = true;
            }
            ...
            if (ddlEmp_CurState.Items.FindByValue(dsRecord.Tables[0].Rows[0]["Emp_CurState"].ToString()) != null)
            {
            ...
            if (ddlEmp_CurCity.Items.FindByValue(dsRecord.Tables[0].Rows[0]["Emp_CurCity"].ToString()) != null)
            {
            ...
            if (ddlEmp_PerState.Items.FindByValue(dsRecord.Tables[0].Rows[0]["Emp_PerState"].ToString()) != null)
            {
            ...
            if (ddlEmp_PerCity.Items.FindByValue(dsRecord.Tables[0].Rows[0]["Emp_PerCity"].ToString()) != null)
            {
    ...
    protected void btnUpdatePersonalDetail_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (msg.Trim() == "" && ViewState["Emp_ID"].ToString() != "" && ViewState["Emp_NewID"].ToString() != "")
            {
                ...
                string msg1 = "";
                DataSet ds1 = objdb.ByProcedure("SpHREmployee", new string[] { "flag", "Emp_AadharNo", "Emp_PanCardNo", "Emp_MobileNo", "Emp_Email", "Emp_ID" }, new string[] { "42", txtEmp_AadharNo.Text, txtEmp_PanCardNo.Text, txtEmp_MobileNo.Text, txtEmp_Email.Text, ViewState["Emp_NewID"].ToString() }, "dataset");
                if (ds1.Tables[0].Rows.Count != 0)
                {
                    msg1 += "AADHAAR No. is Already Exists.<br/>";
                }
                if (ds1.Tables[1].Rows.Count != 0)
                {
                    msg1 += "PAN CARD No. is Already Exists.<br/>";
                }
                if (ds1.Tables[2].Rows.Count != 0)
                {
                    msg1 += "MOBILE No. is Already Exists.<br/>";
                }
                if (ds1.Tables[3].Rows.Count != 0)
                {
                    msg1 += "EMAIL ID is Already Exists.<br/>";
                }
                //if (msg1 != "")
                //{
                //    Page.ClientScript.RegisterStartupScript(this.GetType(), "CallMyFunction", "openModal()", true);
                ...
                {
                    lblPersonalDetail.Text = objdb.Alert("fa-check", "alert-danger", "Sorry!", msg1);
                    Page.ClientScript.RegisterStartupScript(this.GetType(), "CallMyFunction", "openModal()", true);
    ...
    protected void FillOfficialDetail()
    {
        try
        {
            ...
            if (dsRecord != null && dsRecord.Tables[0].Rows.Count > 0)
            {
                ...
                if (ddlOfficeType_Title.Items.FindByValue(dsRecord.Tables[0].Rows[0]["OfficeType_Title"].ToString()) != null)
                {
                ...
                if (ddlOffice_ID.Items.FindByValue(dsRecord.Tables[0].Rows[0]["Office_ID"].ToString()) != null)
                {
                ...
                if (ddlLevel.Items.FindByValue(dsRecord.Tables[0].Rows[0]["EmpLevel_ID"].ToString()) != null)
                {
                    ddlLevel.Items.FindByValue(dsRecord.Tables[0].Rows[0]["EmpLevel_ID"].ToString()).Selected = true;
                }

                ddlEmp_Class.ClearSelection();
                if (ddlEmp_Class.Items.FindByValue(dsRecord.Tables[0].Rows[0]["Emp_Class"].ToString()) != null)
                {
                    ddlEmp_Class.Items.FindByValue(dsRecord.Tables[0].Rows[0]["Emp_Class"].ToString()).Selected = true;
                }
                ddlDepartment_ID.ClearSelection();

                if (ddlDepartment_ID.Items.FindByValue(dsRecord.Tables[0].Rows[0]["Department_ID"].ToString()) != null)
                {
                ...
                if (ddlDesignation_ID.Items.FindByValue(dsRecord.Tables[0].Rows[0]["Designation_ID"].ToString()) != null)
                {
                ...
                if (ddlPayScale_ID.Items.FindByValue(dsRecord.Tables[0].Rows[0]["PayScale_ID"].ToString()) != null)
                {
                    ddlPayScale_ID.Items.FindByValue(dsRecord.Tables[0].Rows[0]["PayScale_ID"].ToString()).Selected = true;
                }
                FillGradPay();
                ddlGradPay_ID.ClearSelection();
                if (ddlGradPay_ID.Items.FindByValue(dsRecord.Tables[0].Rows[0]["GradPay_ID"].ToString()) != null)
                {
                ...
                if (ddlEmp_TypeOfRecruitment.Items.FindByValue(dsRecord.Tables[0].Rows[0]["Emp_TypeOfRecruitment"].ToString()) != null)
                {
                ...
                if (ddlEmp_TypeOfPost.Items.FindByValue(dsRecord.Tables[0].Rows[0]["Emp_TypeOfPost"].ToString()) != null)
                {
                ...
                if (ddlEmp_GpfType.Items.FindByValue(dsRecord.Tables[0].Rows[0]["Emp_GpfType"].ToString()) != null)
                {
                ...
                //string Emp_NPF = dsRecord.Tables[0].Rows[0]["Emp_NPF"].ToString();
                //if (Emp_NPF == "True")
                //{
                //    chknpf.Checked = true;
                //}
    ...
    protected void btnUpdateOfficialDetail_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (msg.Trim() == "" && ViewState["Emp_ID"].ToString() != "")
            {
                ...
                string msg1 = "";
                DataSet ds1 = objdb.ByProcedure("SpHRBankDetail", new string[] { "flag", "Bank_AccountNo" }, new string[] { "5", txtBank_AccountNo.Text }, "dataset");
                if (ds1.Tables[0].Rows.Count != 0)
                {
                    msg1 += "Bank Account No. is Already Exists.\\n";
                }
                if (msg1 == "")
                {

                    //string npf = "0";
                    //if (chknpf.Checked == true)
                    //{
                    //    npf = "1";
                    //}
                    ds = objdb.ByProcedure("SpHREmployee",
    ...
    protected void FillBankDetail()
    {
        try
        {
            ...
            if (dsRecord != null && dsRecord.Tables[0].Rows.Count > 0)
            {
                ...
                ddlBank_Name.Items.FindByValue(dsRecord.Tables[0].Rows[0]["Bank"].ToString()).Selected = true;
    ...
    protected void btnUpdateBankDetail_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (msg.Trim() == "")
            {
                ...
                string msg1 = "";
                DataSet ds1 = objdb.ByProcedure("SpHRBankDetail", new string[] { "flag", "Bank_AccountNo", "Emp_ID" }, new string[] { "5", txtBank_AccountNo.Text, ViewState["Emp_NewID"].ToString() }, "dataset");
                if (ds1.Tables[0].Rows.Count != 0)
                {
                    msg1 += "Not able to edit Bank account info\\n";
                    //Page.ClientScript.RegisterStartupScript(this.GetType(), "CallMyFunction", "openModal2()", true);
                }
                ...
                if (msg1 == "")
                {
                    ...
                    if (btnUpdateBankDetail.Text == "Update" && ViewState["Bank_ID"].ToString() != "")
                    {
                        ds = objdb.ByProcedure("SpHRBankDetail",
                               new string[] { "flag", "Bank_ID", "Bank_AccountNo", "Bank_AccountType", "Bank", "Bank_Name", "Bank_BranchName", "Bank_IfscCode", "Bank_UpdatedBy" },
                               new string[] { "3", ViewState["Bank_ID"].ToString(), txtBank_AccountNo.Text, ddlBank_AccountType.SelectedValue, ddlBank_Name.SelectedValue, ddlBank_Name.SelectedItem.Text, txtBank_BranchName.Text, txtBank_IfscCode.Text, ViewState["Emp_ID"].ToString() }, "dataset");

                    }
                    if (btnUpdateBankDetail.Text == "Save" && ViewState["Emp_NewID"].ToString() != "")
                    {
                        ds = objdb.ByProcedure("SpHRBankDetail",
                                new string[] { "flag", "Emp_ID", "Bank_AccountNo", "Bank_AccountType", "Bank", "Bank_Name", "Bank_BranchName", "Bank_IfscCode", "Bank_UpdatedBy" },
                                new string[] { "0", ViewState["Emp_NewID"].ToString(), txtBank_AccountNo.Text, ddlBank_AccountType.SelectedValue, ddlBank_Name.SelectedValue, ddlBank_Name.SelectedItem.Text, txtBank_BranchName.Text, txtBank_IfscCode.Text, ViewState["Emp_ID"].ToString() }, "dataset");
                ...
                else
                {
                    //Page.ClientScript.RegisterStartupScript(this.GetType(), "CallMyFunction", "alert('" + msg1 + "');", true);
                    Page.ClientScript.RegisterStartupScript(this.GetType(), "CallMyFunction", "openModal2()", true);
                    lblBankDetail.Text = objdb.Alert("fa-ban", "alert-danger", "Sorry!", msg1);
    ...
    protected void FillFixedAssetsDetail()
    {
        try
        {
            ...
            if (dsRecord != null && dsRecord.Tables[0].Rows.Count > 0)
            {
                ...
                ddlProperty_PurchaseYear.SelectedValue = dsRecord.Tables[0].Rows[0]["Property_PurchaseYear"].ToString();
    ...
    {
        ddlProperty_PurchaseYear.Items.Clear();

        for (int i = DateTime.Now.Year; i >= 1950; i--)
        {
            ddlProperty_PurchaseYear.Items.Add(i.ToString());

        }
        ddlProperty_PurchaseYear.Items.Insert(0, new ListItem("Select", "0"));
    ...
    protected void btnUpdateFixedAssetsDetail_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ddlProperty_PurchaseYear.SelectedIndex == 0)
            {
                msg += "Select Property Purchase Year. <br/>";
            }
            ...
            if (msg.Trim() == "")
            {
                if (btnUpdateFixedAssetsDetail.Text == "Update" && ViewState["Property_ID"].ToString() != "")
                {
                    ...
                    new string[] { "3", ViewState["Property_ID"].ToString(), ddlProperty_Type.SelectedValue.ToString(), txtProperty_Location.Text, ddlProperty_PurchaseYear.SelectedValue, txtProperty_PurchasePrice.Text, txtProperty_CurrentRate.Text, ViewState["Emp_ID"].ToString() }, "dataset");
                }
                ...
                new string[] { "0", ViewState["Emp_NewID"].ToString(), ddlProperty_Type.SelectedValue.ToString(), txtProperty_Location.Text, ddlProperty_PurchaseYear.SelectedValue, txtProperty_PurchasePrice.Text, txtProperty_CurrentRate.Text, ViewState["Emp_ID"].ToString() }, "dataset");
                }
                if (ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    ddlProperty_PurchaseYear.ClearSelection();
    ...
    protected void btnUpdateOtherDetail_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                msg += "Entar प्रशिक्षण से संबंधित जानकारी (Training related Information ). <br/>";
            }
    ...
    protected void rbtEmp_Disability_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ddlEmp_DisabilityType.ClearSelection();
            if (rbtEmp_Disability.SelectedValue == "Yes")
            {
                Page.ClientScript.RegisterStartupScript(this.GetType(), "CallMyFunction", "openModal()", true);
                ddlEmp_DisabilityType.Enabled = true;
                //ddlEmp_DisabilityType.SelectedValue = "Select";
            }
            else if (rbtEmp_Disability.SelectedValue == "No")
            {
                Page.ClientScript.RegisterStartupScript(this.GetType(), "CallMyFunction", "openModal()", true);
                if (ddlEmp_DisabilityType.Items.FindByValue("NA/लागू नहीं") != null)
                {
                    ddlEmp_DisabilityType.Items.FindByValue("NA/लागू नहीं").Selected = true;
                }
                //ddlEmp_DisabilityType.SelectedValue = "NA/लागू नहीं";
                ddlEmp_DisabilityType.Enabled = false;
            }
        }
        catch (Exception)
        {
    ...
    protected void chkSelect_CheckedChanged(object sender, EventArgs e)
    {
        ...
        CheckBox chk = (CheckBox)GridView1.Rows[selRowIndex].FindControl("chkSelect");
        string EmpId = chk.ToolTip.ToString();
        bool District_IsActive = false;
        if (chk != null & chk.Checked)
        {
            District_IsActive = true;
        }
        objdb.ByProcedure("USPEmpTaskIsActive",
        new string[] { "Emp_Id", "Emp_Status"},
        new string[] {  EmpId, District_IsActive.ToString() }, "dataset");
        FillDetail();
    }
}