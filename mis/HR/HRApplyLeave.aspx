                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            ...
                                            <asp:TextBox ID="txtFromDate" runat="server" placeholder="Select Date..." class="form-control DateAdd" data-date-start-date="-60d" autocomplete="off" onpaste="return false" ClientIDMode="Static"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            ...
                                            <asp:TextBox ID="txtToDate" runat="server" placeholder="Select Effective Date..." class="form-control DateAdd" autocomplete="off" onpaste="return false" ClientIDMode="Static" data-date-start-date="-60d"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
