                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <asp:GridView ID="GridView1" ShowHeaderWhenEmpty="true" EmptyDataText="No Record Found" runat="server" class=" table table-hover table-bordered pagination-ys" AutoGenerateColumns="False" DataKeyNames="Emp_ID">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Status" ShowHeader="False">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkVerify" runat="server" CausesValidation="False" Text='<%# Eval("Status").ToString()%>' CommandName="select" ToolTip='<%# Eval("Emp_ID").ToString()%>' OnClick="lnkVerify_Click"  OnClientClick='<%# "return confirm(\"Do You Really Want to "+( Eval("Emp_IsActive").ToString() == "1" ? "Retired" : "Verify")+" ?\")"%>'></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Task" ShowHeader="False">
                                        <ItemTemplate>
                                             <asp:CheckBox ID="chkSelect" OnCheckedChanged="chkSelect_CheckedChanged" runat="server" ToolTip='<%# Eval("Emp_ID").ToString()%>' Checked='<%# Eval("Emp_Status").ToString()=="1" ? true : false %>' AutoPostBack="true" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group date">
                                                                        ...
                                                                        <asp:TextBox ID="txtEmp_Dob" runat="server" placeholder="Select Date of birth..." Enabled='<%# Eval("Emp_IsActive").ToString()=="1" ? false : true %>' class="form-control DateAdd" autocomplete="off" data-date-end-date="-18y" onpaste="return false" ClientIDMode="Static"></asp:TextBox>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <asp:RadioButtonList ID="rbtEmp_Disability" runat="server" ClientIDMode="Static" RepeatColumns="2" AutoPostBack="true" OnSelectedIndexChanged="rbtEmp_Disability_SelectedIndexChanged">
                                                ...
                                                <div class="box-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <%--  <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label>NPF</label>
                                                               <asp:CheckBox ID="chknpf" runat="server" />
                                                            </div>
                                                        </div>--%>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <asp:DropDownList ID="ddlBank_Name" runat="server" placeholder="Select Bank Name..." class="form-control"></asp:DropDownList>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <asp:DropDownList ID="ddlProperty_PurchaseYear" runat="server" CssClass="form-control">
                                                                    </asp:DropDownList>
                                                                </div>
                                                            </div>
                                                        </div>
