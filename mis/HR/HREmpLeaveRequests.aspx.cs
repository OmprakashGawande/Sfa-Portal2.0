...
public partial class mis_HR_HREmpLeaveRequests : System.Web.UI.Page
{
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ds.Tables[0].Rows.Count != 0)
            {
                ...
                ViewState["Leavefromdate"] = ds.Tables[0].Rows[0]["LeaveFromDate"].ToString();
    ...
    protected void btnApprove_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            //DateTime leaveFromDate = Convert.ToDateTime(ViewState["Leavefromdate"].ToString(), cult);

            //DateTime orderDateC = Convert.ToDateTime(txtOrderDate.Text, cult);

            //if (leaveFromDate < orderDateC)
            //{
            ...
            //{
            //    Page.ClientScript.RegisterStartupScript(this.GetType(), "CallMyFunction", "callalert()", true);
            //    lblmsgmodal.Text = objdb.Alert("fa-check", "alert-warning", "Sorry!","Order date must be greater than Leave date");
            //}
