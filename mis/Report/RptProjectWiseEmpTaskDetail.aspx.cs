...
public partial class mis_Report_RptProjectWiseEmpTaskDetail : System.Web.UI.Page
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            if (Page.IsValid)
            {
                ...
                Grid.DataBind();
                DataSet ds = objdb.ByProcedure("Usp_GetTaskAllocationProjectWiseEmpDetail", new string[] { "ProjectId" }, new string[] { ddlProjectName.SelectedValue }, "dataset");
