                ...
                <div class="col-md-12">
                    <div class="box box-success">
                        <div class="box-header">
                            <h3 class="box-title">Project Wise Employee Task Allocation Report</h3>
                        </div>
                        <hr />
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                <a href="RptProjectWiseEmpTaskDetail.aspx" style="margin-top: 22px;" class="btn btn-block btn-default">Clear</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    buttons: [
                        {
                            ...
                            title: function () {
                                return 'Project Wise Employee Task Allocation Report - ' + getFormattedDateTime();
                            },
                            exportOptions: {
                        ...
                        },
                        {
                            ...
                            title: function () {
                                return 'Project Wise Employee Task Allocation Report - ' + getFormattedDateTime(true); // Use '-' in time
                            },
                            exportOptions: {
                                columns: [0, 1, 2, 3, 4, 5, 6]
                            },
