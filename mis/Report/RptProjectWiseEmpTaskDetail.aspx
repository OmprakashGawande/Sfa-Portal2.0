<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RptProjectWiseEmpTaskDetail.aspx.cs" Inherits="mis_Report_RptProjectWiseEmpTaskDetail" %>
            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4>Project Wise Employee Task Allocation Report</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <a href="RptProjectWiseEmpTaskDetail.aspx" class="btn btn-block btn-outline-danger">Clear</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body dark-modal">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="modal-title" id="myLargeModalLabel">Project Wise Employee Task Allocation Detail</h4>
                        </div>
                                            ...
                                            <asp:GridView ID="GridTaskDetail" PageSize="50" runat="server" class="datatable2 table  table-hover table-bordered pagination-ys" OnRowDataBound="GridTaskDetail_RowDataBound" ShowHeaderWhenEmpty="true" AutoGenerateColumns="False" OnRowCommand="Grid_RowCommand">
                                                <Columns>
                                                    <asp:TemplateField HeaderText="S.No." ItemStyle-Width="3%" ItemStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            <asp:Label ID="Label1" Text='<%# Container.DataItemIndex + 1 %>' ToolTip='<%# Eval("ProjectId").ToString() %>' runat="server" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="PROJECT NAME">
                                                        <ItemTemplate>
                                                            <asp:Label ID="Label2" Text='<%# Eval("ProjectName") %>' runat="server" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentFooter" runat="Server">
    <script>
        ...
        $('#exampleModal').on('shown.bs.modal', function () {
            ...
            initCustomDataTable('.datatable2', 'Project Wise Employee Task Allocation Report', 'Project Wise Employee Task Allocation Report');
            // Adjust columns after showing
            $('.datatable2').DataTable().columns.adjust();
        });
        $(document).ready(function () {
            initCustomDataTable('.datatable', 'Project Wise Employee Task Allocation Report', 'Project Wise Employee Task Allocation Report');
        });
