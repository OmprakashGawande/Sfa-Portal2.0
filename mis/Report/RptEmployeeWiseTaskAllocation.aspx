                ...
                <div class="col-md-12">
                    <div class="box box-success">
                        <div class="box-header">
                            <h3 class="box-title">Employee Wise Task Allocation Report</h3>
                        </div>
                        <hr />
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                <a href="RptEmployeeWiseTaskAllocation.aspx" style="margin-top: 22px;" class="btn btn-block btn-default">Clear</a>
                                            </div>
                                        </div>
                                    </div>
