...
public partial class mis_Finance_RptGSTR_3B : System.Web.UI.Page 
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (txtFromDate.Text != "" && txtToDate.Text != "" && Office != "")
            {
                ...
                ds = objdb.ByProcedure("SpFinRptGSTR_3_New", new string[] { "flag", "Office_ID_Mlt", "FromDate", "ToDate" }, new string[] { "1", Office, Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd") }, "dataset");
                if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
                {
    ...
    protected void FILL_Statstics(string VoucherList, string MltVoucherTx_IDNotin)
    {
	    ...
	    GV_Statsticts.DataBind();
            ...
            ds = objdb.ByProcedure("SpFinRptGSTR_3_New", new string[] { "flag", "MIncludedRet", "MltVoucherTx_IDNotin" }, new string[] { "2", VoucherList, MltVoucherTx_IDNotin }, "dataset");
            if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
            {
    ...
    protected void FILLStatsticsDayBook(string MltVoucherTx_ID, string VoucherTx_Type, string MltVoucherTx_IDNotin)
    {
        try
        {
            ...
            if (txtFromDate.Text != "" && txtToDate.Text != "")
            {
                ...
                // lblDateRange.Text = txtFromDate.Text + " to " + txtToDate.Text;
                ds = objdb.ByProcedure("SpFinRptGSTR_3_New",
    ...
    protected void btn5_A_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ds = objdb.ByProcedure("SpFinRptGSTR_3_New", new string[] { "flag", "MltVoucherTx_ID" }, new string[] { "8", MltVoucherTx_ID }, "dataset");
            if (ds != null)
            {
