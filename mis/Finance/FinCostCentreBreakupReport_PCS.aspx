<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="FinCostCentreBreakupReport_PCS.aspx.cs" Inherits="mis_Finance_FinCostCentreBreakupReport_PCS" %>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList runat="server" ID="ddlOffice" ClientIDMode="Static" CssClass="form-control select2" SelectionMode="Multiple" OnSelectedIndexChanged="ddlOffice_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                   <%-- <asp:ListBox runat="server" ID="ddlOffice" ClientIDMode="Static" CssClass="form-control" SelectionMode="Multiple" OnSelectedIndexChanged="ddlOffice_SelectedIndexChanged" AutoPostBack="true"></asp:ListBox>--%>
                                </div>
                            </div>
                            <div class="col-md-2">
