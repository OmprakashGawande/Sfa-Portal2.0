<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RptOutstandingAgeWise_New.aspx.cs" Inherits="mis_Finance_RptOutstandingAgeWise_New" %>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <asp:ListBox runat="server" ID="ddlOffice" ClientIDMode="Static" CssClass="form-control" SelectionMode="Multiple" AutoPostBack="true" OnSelectedIndexChanged="ddlOffice_SelectedIndexChanged1"></asp:ListBox>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Ageing</label>
                                    : &nbsp;&nbsp;
                                    <asp:CheckBox ID="chk0_30" runat="server"  Text="0 To 30 Days &nbsp;&nbsp;&nbsp;&nbsp;" />
                                    <asp:CheckBox ID="chk30_60" runat="server"  Text="30 To 60 Days &nbsp;&nbsp;&nbsp;&nbsp" />
                                    <asp:CheckBox ID="chk60_90" runat="server" Text="60 To 90 Days &nbsp;&nbsp;&nbsp;&nbsp" />
                                    <asp:CheckBox ID="chk90_180" runat="server" Text="90 To 180 Days &nbsp;&nbsp;&nbsp;&nbsp" />
                                    <asp:CheckBox ID="chk180_365" runat="server"  Text="180 To 365 Days &nbsp;&nbsp;&nbsp;&nbsp" />
                                    <asp:CheckBox ID="chk365_0" runat="server" Text="Older than 365 Days &nbsp;&nbsp;&nbsp;&nbsp" />
                                </div>
                            </div>
                        </div>
                    </div>
