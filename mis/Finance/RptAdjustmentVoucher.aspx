<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RptAdjustmentVoucher.aspx.cs" Inherits="mis_Finance_RptAdjustmentVoucher" EnableEventValidation="false" %>
        ...
        <section class="content">
            <div class="box box-success">
                <div class="box-header Hiderow">
                    <h3 class="box-title">Adjustment Voucher</h3>
                   <p class="hide_print">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <asp:GridView ID="GridView1" DataKeyNames="VoucherTx_ID" runat="server" ShowFooter="true" AutoGenerateColumns="false" CssClass="datatable table table-hover table-bordered pagination-ys" ShowHeaderWhenEmpty="true" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowDeleting="GridView1_RowDeleting" EmptyDataText="No Record Found" ClientIDMode="Static" OnRowCommand="GridView1_RowCommand">
                                    <Columns>
                                        <asp:TemplateField HeaderText="Voucher Date" ItemStyle-Width="5%">
                                            <ItemTemplate>
