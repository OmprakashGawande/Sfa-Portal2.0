<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RptGSTR_1F.aspx.cs" Inherits="mis_Finance_RptGSTR_1F" %>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-bordered" style="margin-bottom: 0px;">
                                            <tr>
                                                ...
                                                <th>
                                                    <asp:Label ID="lblTTaxableValue" runat="server" Text="4646464"></asp:Label>
                                                </th>
                                                    ...
                                                    <td valign="Top" width="100%">
                                                        <table cellspacing="0" cellpadding="0" border="0" width="100%" height="20">
                                                            <tr>
                                                                ...
                                                                <td width="2">&#160;</td>
                                                                <td width="3">&#160;  </td>
                                                                <td valign="Bottom" style="color: #000000; font: 9pt 'Arial';" width="110" align="Left">
                                                                </td>
...
<tr>
                                                    <td valign="Top" width="100%">
                                                        <table cellspacing="0" cellpadding="0" border="0" width="100%" height="26">
                                                            <tr>
                                                                ...
                                                                <td valign="Bottom"
                                                                    style="color: #000000; font: 9pt 'Arial';"
                                                                    width="180" align="Left"> <asp:LinkButton ID="lnkbtnHSNItemWiseSummary" runat="server" OnClick="lnkbtnHSNItemWiseSummary_Click">  HSN/SAC Item Wise Summary - 12</asp:LinkButton>
                                                                </td>
                                                                ...
                                                                <td valign="Bottom" style="color: #000000; white-space: nowrap; font: 9pt 'Arial';" width="106" align="Right">&#160;
                                                                <asp:Label ID="lblHSNTaxableValue_ItemWise" runat="server" Text=""></asp:Label>
                                                                ...
                                                                <td valign="Bottom" style="color: #000000; white-space: nowrap; font: 9pt 'Arial';" width="85" align="Right">&#160;
                                                                <asp:Label ID="lblHSNIntegratedTaxAmount_ItemWise" runat="server" Text=""></asp:Label>
                                                                </td>
                                                                ...
                                                                <td valign="Bottom" style="color: #000000; white-space: nowrap; font: 9pt 'Arial';" width="85" align="Right">&#160;
                                                                <asp:Label ID="lblHSNCentralTaxAmount_ItemWise" runat="server" Text=""></asp:Label>
                                                                </td>
                                                                ...
                                                                <td valign="Bottom" style="color: #000000; white-space: nowrap; font: 9pt 'Arial';" width="113" align="Right">&#160;
                                                                  <asp:Label ID="lblHSNStateUTTaxAmount_ItemWise" runat="server" Text=""></asp:Label></td>
                                                                ...
                                                                <td valign="Bottom" style="color: #000000; white-space: nowrap; font: 9pt 'Arial';" width="85" align="Right">&#160;
                                                                  <asp:Label ID="lblHSNCessAmt_ItemWise" runat="server" Text=""></asp:Label></td>
                                                                ...
                                                                <td valign="Bottom" style="color: #000000; white-space: nowrap; font: 9pt 'Arial';" width="85" align="Right">&#160;
                                                                 <asp:Label ID="lblHSNTotalTaxAmt_ItemWise" runat="server" Text=""></asp:Label>
                                                                </td>
                                                    ...
                                                    <td valign="Top" width="100%">
                                                        <table cellspacing="0" cellpadding="0" border="0" width="100%" height="16">
                                                            <tr>
                                                                ...
                                                                <td valign="Bottom"
                                                                    style="color: #0000ff; font: italic 9pt 'Arial';"
                        ...
                        <div class="col-md-2">
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <asp:Button ID="btnBack" runat="server" CssClass="btn  label-primary Aselect1" Text="Back" OnClick="btnBack_Click" OnClientClick="return validateform();" />
                                        <asp:Button ID="btnBackNext" runat="server" CssClass="btn  label-primary Aselect1" Text="Back" OnClick="btnBackNext_Click" OnClientClick="return validateform();" />
                                    ...
                                    <asp:GridView ID="GridView2" DataKeyNames="VoucherTx_ID" runat="server" AutoGenerateColumns="false" class="table table-hover table-bordered" ShowFooter="true">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Vch No.">
                                             ...
                                             <asp:TemplateField HeaderText="Vch Date">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblVoucherTx_Date" Text='<%# Eval("VoucherTx_Date").ToString() %>' runat="server" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="GST No" ItemStyle-Width="8%">
                                                <ItemTemplate>
					...
					<asp:GridView ID="GridHSNItemWiseSummary" runat="server" AutoGenerateColumns="false" class="table table-hover table-bordered" OnRowCommand="GridHSNItemWiseSummary_RowCommand" ShowFooter="true">
                                        <Columns>
                                            <asp:TemplateField HeaderText="SNo." ItemStyle-Width="5%">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblRowNumber" Text='<%# Container.DataItemIndex + 1 %>' runat="server" />
