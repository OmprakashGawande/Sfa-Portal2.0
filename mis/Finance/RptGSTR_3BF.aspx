<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RptGSTR_3BF.aspx.cs" Inherits="mis_Finance_RptGSTR_3BF" %>
                    ...
                    <div class="">
                        ...
                        <div id="testTable">
                            <asp:Panel ID="DivTable" class="font" runat="server">
                                <div>
                                    <table style="width: 100%">
                                        <tr style="text-align: center">
                                            <td><b>M.P. State Minor Forest Produce(T & D)Co-op. Fed. Ltd</b></td>
                                        </tr>
                                        <tr>
                                            <td>
                                ...
                                <div style="background: #ffe6c8; padding: 5px;">
                                    <table style="width: 100%; margin-bottom: 0px;" class="table table-hover no-border">
                                        <tr>
                                            <td style="font-weight: bold; border-top: 1px solid #000;" colspan="5">GSTIN/UIN: </td>
						 ...
						 <asp:TemplateField HeaderText="Supplier Invoice No.">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblVoucherTx_Ref" Text='<%# Eval("VoucherTx_Ref").ToString() %>' runat="server" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                 <asp:TemplateField HeaderText="Supplier Invoice Date.">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblVoucherTx_SupplierinvoiceDate" Text='<%# Eval("VoucherTx_SupplierinvoiceDate").ToString() %>' runat="server" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>    
                                                ...
                                                <asp:TemplateField HeaderText="Action" ItemStyle-Width="7%" ItemStyle-CssClass="no-print" HeaderStyle-CssClass="no-print">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:HyperLink ID="hpEdit" runat="server" Target="_blank" NavigateUrl='<%# Eval("PageURL").ToString()+ "?VoucherTx_ID=" + APIProcedure.Client_Encrypt(Eval("VoucherTx_ID").ToString())+"&Action="+ APIProcedure.Client_Encrypt("2")+"&Office_ID="+ APIProcedure.Client_Encrypt(Eval("Office_ID").ToString()) %>' Visible='<%# Eval("V_Editright").ToString() == "Yes" ? true : false %>' CssClass="label label-info">Edit</asp:HyperLink>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
