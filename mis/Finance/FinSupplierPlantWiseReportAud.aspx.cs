...
public partial class mis_Finance_FinSupplierPlantWiseReportAud : System.Web.UI.Page
{
    DataSet ds, ds1;
         ...
         try
        {
            ...
            if (txtFromDate.Text != "" && txtToDate.Text != "" )
            {
                ds = objdb.ByProcedure("SpFinSupplierOrder",
                    ...
                    new string[] { "17", Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd"), ddlPlant.SelectedValue.ToString() }, "dataset");
                    ...
                    for (int i = 0; i < OrderRowCount; i++)
                    {
                        ...
                        ds1 = objdb.ByProcedure("SpFinSupplierOrder",
                             new string[] { "flag", "OrderDate", "PlantID", "OrderNo", "SupplierID" },
                                new string[] { "18", Convert.ToDateTime(OrderDate, cult).ToString("yyyy/MM/dd"), ds.Tables[0].Rows[i]["PlantID"].ToString(), OrderNo, ds.Tables[0].Rows[i]["SupplierID"].ToString() }, "dataset");
