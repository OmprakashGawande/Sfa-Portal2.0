...
public partial class mis_Finance_RptLedgerSummary : System.Web.UI.Page
{
    ...
    protected void FillDropdown()
    {
        try
        {
            ...
            if (Office != "")
            {
                DataSet ds1 = objdb.ByProcedure("SpFinRptLedgerSummaryGST", new string[] { "flag", "Office_ID_Mlt" }, new string[] { "1", Office }, "dataset");
                if (ds1.Tables.Count != 0 && ds1.Tables[0].Rows.Count != 0)
                {
                    ddlLedger.DataSource = ds1;
                    ddlLedger.DataTextField = "GST_No";
                    ddlLedger.DataValueField = "GST_No";
                    ddlLedger.DataBind();
    ...
    protected void ddlOffice_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            //{
            //    DataSet ds1 = objdb.ByProcedure("SpFinRptLedgerSummaryGST", new string[] { "flag", "Office_ID" }, new string[] { "1", ddlOffice.SelectedValue.ToString() }, "dataset");
            //    if (ds1.Tables.Count != 0 && ds1.Tables[0].Rows.Count != 0)
            //    {
            //        ddlLedger.DataSource = ds1;
    ...
    protected void FillGrid()
    {
        try
        {
            ...
            if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
            {
                ...
                for (int head_i = 0; head_i < ds.Tables[2].Rows.Count; head_i++)
                {
                    HeadName = HeadName + "  ," + ds.Tables[2].Rows[head_i]["Head_Name"].ToString();
                }
                ...
                if (chkOpeningBal.Checked == true)
                {
                    ...
                    if (OpeningBalance >= 0)
                    {
                        lblReportName.Text = "<p class='text-center' style='font-weight:600'> MP State Agro Industries Development Corporation, <br/>Ledger GST Of : <span style='text-transform: uppercase;font-size: 17px;'>" + ddlLedger.SelectedItem.Text + " </span><br/> Head Name : " + HeadName + " <br>( " + txtFromDate.Text + " - " + txtToDate.Text + " )" + "<span style='color:#d03535;'> Opening Bal. : " + Math.Abs(OpeningBalance).ToString() + " Cr</span><br>[" + OfficeName + "]</p>";

                        HF_ReportName.Value = "Ledger Of - " + ddlLedger.SelectedItem.Text + " [ Head Name : " + HeadName + " ]( " + txtFromDate.Text + " - " + txtToDate.Text + " )" + " Opening Balance - " + Math.Abs(OpeningBalance).ToString() + " Cr";
                    }
                    else
                    {
                        lblReportName.Text = "<p class='text-center' style='font-weight:600'> MP State Agro Industries Development Corporation, <br/>Ledger GST Of : <span style='text-transform: uppercase;font-size: 17px;'>" + ddlLedger.SelectedItem.Text + "</span> <br/> Head Name : " + HeadName + " <br>( " + txtFromDate.Text + " - " + txtToDate.Text + " )" + "<span style='color:#d03535;'> Opening Bal. : " + Math.Abs(OpeningBalance).ToString() + " Dr</span><br>[" + OfficeName + "]</p>";

                        HF_ReportName.Value = "Ledger Of - " + ddlLedger.SelectedItem.Text + " [ Head Name : " + HeadName + " ]( " + txtFromDate.Text + " - " + txtToDate.Text + " )" + " Opening Balance - " + Math.Abs(OpeningBalance).ToString() + " Dr";
                    }
                }
                else
                {

                    lblReportName.Text = "<p class='text-center' style='font-weight:600'> MP State Agro Industries Development Corporation, <br/>Ledger GST Of : <span style='text-transform: uppercase;font-size: 17px;'>" + ddlLedger.SelectedItem.Text + " </span><br/> Head Name : " + HeadName + " <br>( " + txtFromDate.Text + " - " + txtToDate.Text + " )" + "<br>[" + OfficeName + "]</p>";

                    HF_ReportName.Value = "Ledger Of - " + ddlLedger.SelectedItem.Text + " [ Head Name : " + HeadName + " ]( " + txtFromDate.Text + " - " + txtToDate.Text + " )";
                    //OpeningBalance = 0;
                }
            ...
            else if (ds.Tables.Count != 0 && ds.Tables[1].Rows.Count != 0)
            {
                ...
                if (chkOpeningBal.Checked == true && chkClosingBal.Checked == true)
                {
                    if (OpeningBalance >= 0)
                    {
                        ...
                        HF_ReportName.Value = "Ledger Of - " + ddlLedger.SelectedItem.Text + " [ Head Name : " + HeadName + " ]( " + txtFromDate.Text + " - " + txtToDate.Text + " )" + " Opening Balance - " + Math.Abs(OpeningBalance).ToString() + " Cr  & " + "<span style='color:#d03535;'> Closing Balance - " + Math.Abs(OpeningBalance).ToString() + " Cr";
                    }
                    else
                    ...
                    HF_ReportName.Value = "Ledger Of - " + ddlLedger.SelectedItem.Text + " [ Head Name : " + HeadName + " ]( " + txtFromDate.Text + " - " + txtToDate.Text + " )" + " Opening Balance - " + Math.Abs(OpeningBalance).ToString() + " Dr & " + " Closing Balance - " + Math.Abs(OpeningBalance).ToString() + " Dr";
                }
                ...
                else if (chkClosingBal.Checked == true)
                {
                    if (OpeningBalance >= 0)
                    {
                        ...
                        HF_ReportName.Value = "Ledger Of - " + ddlLedger.SelectedItem.Text + " [ Head Name : " + HeadName + " ]( " + txtFromDate.Text + " - " + txtToDate.Text + " )" + " Closing Balance - " + Math.Abs(OpeningBalance).ToString() + " Cr";
                    }
                    else
                    {
                        lblReportName.Text = "<p class='text-center' style='font-weight:600'> MP State Agro Industries Development Corporation, <br/>Ledger GST Of : <span style='text-transform: uppercase;font-size: 17px;'>" + ddlLedger.SelectedItem.Text + " </span><br/> Head Name : " + HeadName + " <br>( " + txtFromDate.Text + " - " + txtToDate.Text + " )" + "<span style='color:#d03535;'> Closing Bal. : " + Math.Abs(OpeningBalance).ToString() + " Dr</span><br>[" + OfficeName + "]</p>";
                        HF_ReportName.Value = "Ledger Of - " + ddlLedger.SelectedItem.Text + " [ Head Name : " + HeadName + " ]( " + txtFromDate.Text + " - " + txtToDate.Text + " )" + " Closing Balance - " + Math.Abs(OpeningBalance).ToString() + " Dr";
                    }
                }
            }
            else
        ...
        try
        {
            ...
            if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
            {
                ...
                for (int i = 0; i < Count; i++)
                {
                    ...
                    DataSet ds1 = objdb.ByProcedure("SpFinRptLedgerSummaryGST", new string[] { "flag", "VoucherTx_ID", "Ledger_ID_GST", }, new string[] { "3", ds.Tables[0].Rows[i]["VoucherTx_ID"].ToString(), ddlLedger.SelectedValue.ToString() }, "dataset");
    ...
    protected void btnShowDetailBook_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ViewState["DayBookVisible"].ToString() == "true")
            {
                ...
                ds = objdb.ByProcedure("SpFinRptLedgerSummaryGST", new string[] { "flag", "Office_ID_Mlt", "Ledger_ID_GST", "FromDate", "ToDate" }, new string[] { "4", Office, ddlLedger.SelectedValue.ToString(), Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd") }, "dataset");
                if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
                {
