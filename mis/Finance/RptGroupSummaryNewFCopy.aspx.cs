...
public partial class mis_Finance_RptGroupSummaryNewFCopy : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void FillDropdown()
    {
        try
        {
            ...
            if (Office != "")
            {
                DataSet ds1 = objdb.ByProcedure("SpFinRptAayVivran", new string[] { "flag", "Office_ID_Mlt", "FromDate", "ToDate" }, new string[] { "1", Office, Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd") }, "dataset");
    ...
    protected void FillGridNext(string Head_ID)
    {
        try
        {
            ...
            ShowColumn();
            DataSet ds1 = objdb.ByProcedure("SpFinRptAayVivran", new string[] { "flag", "VHead_ID_Mlt" }, new string[] { "4", Head_ID }, "dataset");
            if (ds1.Tables.Count != 0 && ds1.Tables[0].Rows.Count != 0)
            {
                ...
                {
                    HeadName += ds1.Tables[0].Rows[i]["Head_Name"].ToString() + ",";
                }
                lblHeadName.Text = HeadName.ToString() + "( " + txtFromDate.Text + " - " + txtToDate.Text + " )";
            ...
            ds = objdb.ByProcedure("SpFinRptAayVivran",
               new string[] { "flag", "Office_ID_Mlt", "VHead_ID_Mlt", "FromDate", "ToDate", "Ledger_ID_Mlt" },
            ...
            ds = objdb.ByProcedure("SpFinRptAayVivran", new string[] { "flag", "Office_ID_Mlt", "VHead_ID_Mlt", "FromDate", "ToDate", "Ledger_ID_Mlt" }, new string[] { "3", Office, Head_ID, Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd"), ViewState["Ledger_ID_Mlt"].ToString() }, "dataset");
            if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
            {
                btnHeadExcel.Visible = true;
                spnAltB.Visible = true;
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        if (Office != "")
        {
            ...
            string headingFirst = "<p class='text-center' style='font-weight:600'>Group Summary <br /> M.P. State Minor Forest Produce(T & D)Co-op. Fed. Ltd, <br/> [ " + OfficeName + " ] <br />  " + Convert.ToDateTime(txtFromDate.Text, cult).ToString("dd-MM-yyyy") + "  To " + Convert.ToDateTime(txtToDate.Text, cult).ToString("dd-MM-yyyy") + "</p>";
