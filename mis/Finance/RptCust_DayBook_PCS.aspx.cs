...
public partial class mis_Finance_RptCust_DayBook_PCS : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void FillGrid()
    {
        try
        {
            ...
            string Office = "";
            Office = ddlOffice.SelectedValue + ",";
            ...
            if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
            {
                string headingFirst = "<p class='text-center' style='font-weight:600; text-align:center'> Custom Day Book<br /> SFA Technologies Pvt. Ltd. <br/> [ " + ddlOffice.SelectedItem.Text + " ] <br />  " + Convert.ToDateTime(txtFromDate.Text, cult).ToString("dd-MM-yyyy") + "  To " + Convert.ToDateTime(txtToDate.Text, cult).ToString("dd-MM-yyyy") + "</p>";
