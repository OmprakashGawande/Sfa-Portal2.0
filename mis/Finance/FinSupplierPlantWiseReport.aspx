<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="FinSupplierPlantWiseReport.aspx.cs" Inherits="mis_Finance_FinSupplierPlantWiseReport" %>
                ...
                <div class="col-md-12">
                    <div class="box box-success">
                        <div class="box-header Hiderow">
                            <h3 class="box-title">Plant Wise Supply Details  (By Order Date)</h3>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12  table-responsive">
                                   <%-- <asp:Button ID="btnPrint" runat="server" CssClass="Hiderow" Text="Print" OnClientClick="window.print();" />--%>
                                     <asp:Button ID="btnPrint" runat="server" CssClass="Hiderow" Text="Print"  OnClick="btnPrint_Click" />
                                    <asp:Button ID="btnExcel" runat="server" CssClass="Hiderow" Text="Export to Excel" OnClick="btnExcel_Click" />
