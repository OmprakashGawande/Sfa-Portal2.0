<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RptGroupSummaryNewFCopy.aspx.cs" Inherits="mis_Finance_RptGroupSummaryNewFCopy" %>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>List Of Group</label><span style="color: red">*</span>
                                     <asp:ListBox runat="server" ID="ddlGroup" ClientIDMode="Static" CssClass="form-control" SelectionMode="Multiple" OnSelectedIndexChanged="ddlGroup_SelectedIndexChanged" AutoPostBack="true"></asp:ListBox>
