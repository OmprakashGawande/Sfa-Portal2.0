        ...
        <section class="content">
            <div class="box box-success">
                <div class="box-header Hiderow">
                    ...
                    <p class="hide_print">
                        <span>[<span class="Scut">Alt+b</span> - Back]
                        </span>
                    </p>
                ...
                <div class="box-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <asp:GridView ID="GridView1" runat="server" ClientIDMode="Static" AutoGenerateColumns="false" class="datatable table table-hover table-bordered" Style="margin-bottom: 0px;" OnRowCommand="GridView1_RowCommand" ShowFooter="true">
                                <Columns>
                                    ...
                                    <asp:ButtonField ButtonType="Link" ControlStyle-CssClass="Aselect1" CommandName="View" HeaderText="Head Name" DataTextField="Head_Name" />
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <asp:GridView ID="GridView4" DataKeyNames="VoucherTx_ID" runat="server" AutoGenerateColumns="false" class="table table-hover table-bordered hidden" OnRowDeleting="GridView4_RowDeleting">
                                <Columns>
                        ...
                        <div class="col-md-4 hidden" runat="server" id="DivDayBookTotal">
