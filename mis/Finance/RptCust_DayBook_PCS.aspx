<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RptCust_DayBook_PCS.aspx.cs" Inherits="mis_Finance_RptCust_DayBook_PCS" EnableEventValidation="false" %>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <%--<asp:DropDownList runat="server" ID="ddlOffice" CssClass="form-control select2">
                                 ...
                                 <asp:DropDownList runat="server" ID="ddlOffice" ClientIDMode="Static" CssClass="form-control select2"></asp:DropDownList>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div runat="server" id="divExcel">
                                ...
                                <asp:LinkButton ID="btnPrint" runat="server" CssClass="btn btn-default no-print" OnClick="btnPrint_Click"><i class="fa fa-print"></i>Print</asp:LinkButton>
                            </div>
