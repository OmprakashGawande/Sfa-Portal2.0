...
public partial class mis_Finance_FinSupplierOrderAccRequest : System.Web.UI.Page
{
    DataSet ds;
         ...
         try
        {
            ...
            if (txtFromDate.Text != "" && txtToDate.Text != "")
            {
                ds = objdb.ByProcedure("SpFinSupplierOrder",
                    ...
                    new string[] { "1", Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd"), ddlStatus.SelectedValue.ToString() }, "dataset");
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                HF_RoundOff.Value = ds.Tables[0].Rows[0]["RoundOff"].ToString();
                HF_NetPayment.Value = ds.Tables[0].Rows[0]["NetPayment"].ToString();
                HF_DeductionAmount.Value = ds.Tables[0].Rows[0]["DeductionAmount"].ToString();
                if(ds.Tables[0].Rows[0]["AccountStatus"].ToString() == "Pending")
                {
                    txtDeductionProposed.Text = ds.Tables[0].Rows[0]["DeductionProposed"].ToString();
                    txtDeductionAmount.Text = ds.Tables[0].Rows[0]["DeductionAmount"].ToString();
    ...
    protected void btnApprove_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (msg.Trim() == "")
            {
               ...
               new string[] { "4", ViewState["OrderID"].ToString(), DeductionProposed, DeductionAmount, RoundOff, NetPayment, txtRemark.Text, ViewState["Emp_ID"].ToString() }, "dataset");
