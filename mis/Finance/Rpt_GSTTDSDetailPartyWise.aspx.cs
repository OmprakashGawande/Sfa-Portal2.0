...
public partial class mis_Finance_Rpt_GSTTDSDetailPartyWise : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void FillDetail()
    {
        ...
        if (txtFromDate.Text != null && txtTodate.Text != null)
        {
            ...
            ds = objdb.ByProcedure("SpFinTDSGSTEntry",
                                  ...
                                  new string[] { "9", Office, Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtTodate.Text, cult).ToString("yyyy/MM/dd") }, "dataset");
            if (ds != null && ds.Tables[0].Rows.Count > 0)
            {
                divExcel.Visible = true;
                string headingFirst = "<p class='text-center' style='font-weight:600'>GST TDS Party Wise Detail<br /> MP State Agro Industries Development Corporation, <br/> [ " + OfficeName + " ] <br />  (" + Convert.ToDateTime(txtFromDate.Text, cult).ToString("dd-MM-yyyy") + "  To " + Convert.ToDateTime(txtTodate.Text, cult).ToString("dd-MM-yyyy") + ")</p>";
                gvTDSDetail.DataSource = ds.Tables[0];
                gvTDSDetail.DataBind();


                gvTDSDetail.FooterRow.Cells[3].Text = "<b>Total </b>";
                gvTDSDetail.FooterRow.Cells[4].Text = "<b>" + ds.Tables[1].Rows[0]["TotalBillAmount"].ToString() + "</b>";
                gvTDSDetail.FooterRow.Cells[5].Text = "<b>" + ds.Tables[1].Rows[0]["PaymentAmount"].ToString() + "</b>";
                gvTDSDetail.FooterRow.Cells[6].Text = "<b>" + ds.Tables[1].Rows[0]["BasicAmount"].ToString() + "</b>";
                gvTDSDetail.FooterRow.Cells[7].Text = "<b>" + ds.Tables[1].Rows[0]["GSTTDSAmount"].ToString() + "</b>";
                gvTDSDetail.FooterRow.Cells[8].Text = "<b>" + ds.Tables[1].Rows[0]["CGST"].ToString() + "</b>";
                gvTDSDetail.FooterRow.Cells[9].Text = "<b>" + ds.Tables[1].Rows[0]["SGST"].ToString() + "</b>";
                gvTDSDetail.FooterRow.Cells[10].Text = "<b>" + ds.Tables[1].Rows[0]["IGST"].ToString() + "</b>";
