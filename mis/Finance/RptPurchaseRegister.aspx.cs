...
public partial class mis_Finance_RptPurchaseRegister : System.Web.UI.Page
{
    ...
    protected void FillGridNextLedger()
    {
        try
        {
            ...
            if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
            {
                string headingFirst = "<p class='text-center' style='font-weight:600'>Purchase Register <br /> MP State Agro Industries Development Corporation, <br/> [ " + OfficeName + " ] <br /></p>";
    ...
    protected void btngraphical_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Office != "")
            {
                ...
                headingFirst = "<p class='text-center' style='font-weight:600'>Purchase Register<br /> MP State Agro Industries Development Corporation, <br/> [ " + OfficeName + " ] <br />  " + Convert.ToDateTime(txtFromDate.Text, cult).ToString("dd-MM-yyyy") + "  To " + Convert.ToDateTime(txtToDate.Text, cult).ToString("dd-MM-yyyy") + "</p>";
