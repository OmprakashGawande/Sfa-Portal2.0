<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RptBudget_Alloction_DfoWise.aspx.cs" Inherits="mis_Finance_RptBudget_Alloction_DfoWise" %>
        ...
        <section class="content">
            <div class="box box-success">
                <div class="box-header Hiderow">
                    <h3 class="box-title">Budget Allocation Report</h3>
                ...
                <div class="box-body">
                    <div class="row Hiderow">
                        ...
                        <div class="col-md-1">
                         ...
                         <div class="col-md-1">
                              <a runat="server" id="btnClear" class="btn btn-block btn-default" style="margin-top:25px;" href="Budget_Alloction_DfoWise.aspx">Clear</a>
                            </div>
                    </div>
                    <fieldset>
                        <legend class="Hiderow">Budget Allocation Report</legend>
                        <div class="row">
                            ...
                            <div class="col-md-3">
                               ...
                               <asp:Button runat="server" Text="Export" OnClientClick="tableToExcel('testTable', 'Budget Allocation','Budget Allocation')" ID="btnExport" class="btn btn-flat btn-success Hiderow" />
                            ...
                            <div class="col-md-12">
                                <asp:GridView runat="server" CssClass="table table-bordered" ID="GridView1" ShowFooter="true" AutoGenerateColumns="false">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Amount">
                                            <ItemTemplate>
                                                <asp:Label ID="txtBudget_Amount" runat="server" Text='<%# Eval("Budget_Amount").ToString()%>'></asp:Label>
