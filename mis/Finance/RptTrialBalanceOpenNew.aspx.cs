...
public partial class mis_Finance_RptTrialBalanceOpenNew : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void FillGrid()
    {
        try
        {
            ...
            if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
            {
                ...
                ds.Tables[0].Rows.Add("-1", "Difference in Opening Balances", "0", "0", "0", "0", "0", "0", "0", "0");
    ...
    protected void FillGridNextLedger(string Ledger_ID)
    {
        try
        {
            ...
            if (ds1.Tables.Count != 0 && ds1.Tables[0].Rows.Count != 0)
            {
                lblHeadName.Text = "<p class='text-center' style='font-weight:600'>( " + ds1.Tables[0].Rows[0]["Ledger_Name"].ToString() + " )</p>";
            }
            GridView3.DataSource = new string[] { };
            GridView3.DataBind();
            string Office = "";
            ...
            if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
            {
                ...
                if (chkOpeningBal.Checked == true)
                {
                    ...
                    {
                        lblHeadName.Text = "<p class='text-center' style='font-weight:600'>" + lblHeadName.Text + "<span style='color:#d03535;'> Opening Bal. : " + Math.Abs(PreOpening + decimal.Parse(ds.Tables[0].Rows[0]["CurrentOpening"].ToString())).ToString() + " Dr </span></p>";
                    }
                    else
                    {
                        lblHeadName.Text = "<p class='text-center' style='font-weight:600'>" + lblHeadName.Text + "<span style='color:#d03535;'> Opening Bal. : " + Math.Abs(PreOpening + decimal.Parse(ds.Tables[0].Rows[0]["CurrentOpening"].ToString())).ToString() + " Cr </span></p>";
                    }
                }
    ...
    protected void FillGridNextLedgerMonth(string Ledger_ID, string MonthID)
    {
        try
        {
            ...
            if (ds1.Tables.Count != 0 && ds1.Tables[0].Rows.Count != 0)
            {
                ...
                lblHeadName.Text = "<p class='text-center' style='font-weight:600'>" + ds1.Tables[0].Rows[0]["Ledger_Name"].ToString() + "( Month : " + mfi.GetMonthName(int.Parse(MonthID)).ToString() + " )</p>"; // + "( " + txtFromDate.Text + " - " + txtToDate.Text + " )";
            }
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        if (Office != "")
        {
            ...
            string headingFirst = "<p class='text-center' style='font-weight:600'>Trial Balance <br /> SFA Technologies Pvt. Ltd. <br/> [ " + OfficeName + " ] <br />  " + Convert.ToDateTime(txtFromDate.Text, cult).ToString("dd-MM-yyyy") + "  To " + Convert.ToDateTime(txtToDate.Text, cult).ToString("dd-MM-yyyy") + "</p>";
    ...
    protected void btngraphical_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Office != "")
            {
                ...
                headingFirst = "<p class='text-center' style='font-weight:600'>Trial Balance <br /> M.P. State Minor Forest Produce(T & D)Co-op. Fed. Ltd, <br/> [ " + OfficeName + " ] <br />  " + Convert.ToDateTime(txtFromDate.Text, cult).ToString("dd-MM-yyyy") + "  To " + Convert.ToDateTime(txtToDate.Text, cult).ToString("dd-MM-yyyy") + "</p>";
