<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RptLedgerSummaryGST.aspx.cs" Inherits="mis_Finance_RptLedgerSummary" %>
        ...
        <section class="content">
            ...
            <div class="box box-success">
                <div class="box-header Hiderow">
                    <h3 class="box-title">Ledger (GST)</h3>
                ...
                <div class="box-body">
                    ...
                    <div class="row Hiderow">
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                <label>List Of Ledger GST</label><span style="color: red">*</span>
