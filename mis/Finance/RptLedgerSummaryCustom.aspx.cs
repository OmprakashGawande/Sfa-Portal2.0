...
public partial class mis_Finance_RptLedgerSummaryCustom : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void FillGrid()
    {
        try
        {
            ...
            if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
            {
                ...
                htmlStr.Append("<tr>");
                htmlStr.Append("<th class='hide_print'></th>");
                ...
                if (chkOpeningBal.Checked == true)
                {
                    ...
                    HF_OpeningBalance.Value = OpeningBalance.ToString();

                    if (OpeningBalance >= 0)
                    {
                        lblReportName.Text = "<p class='text-center' style='font-weight:600'> SFA Technologies Pvt. Ltd. <br/>Ledger Of : <span style='text-transform: uppercase;font-size: 17px;'>" + ddlLedger.SelectedItem.Text + " </span><br/> Head Name : " + HeadName + " <br>( " + txtFromDate.Text + " - " + txtToDate.Text + " )" + "<span style='color:#d03535;'> Opening Bal. : " + Math.Abs(OpeningBalance).ToString() + " Cr</span><br>[" + OfficeName + "]</p>";
                ...
                else
                {
                    ...
                    lblReportName.Text = "<p class='text-center' style='font-weight:600'> SFA Technologies Pvt. Ltd. <br/>Ledger Of : <span style='text-transform: uppercase;font-size: 17px;'>" + ddlLedger.SelectedItem.Text + " </span><br/> Head Name : " + HeadName + " <br>( " + txtFromDate.Text + " - " + txtToDate.Text + " )" + "<br>[" + OfficeName + "]</p>";
                ...
                for (int i = 0; i < Count; i++)
                {
                    ...
                    if (chkCreditAmt.Checked == true && chkDebitAmt.Checked == true)
                    {
                        ...
                        htmlStr.Append("<tr id='row'>");
                        //htmlStr.Append("<td></td>");
                        htmlStr.Append("<td class='hide_print'> <input type='checkbox' id='chk1' class='chkcss' onclick='CalculateClosing();' /></td>");
    ...
    protected void btnBillByBill_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string Ledger_ID = ddlLedger.SelectedValue.ToString();
            lblLedgerName.Text = ddlLedger.SelectedItem.ToString();
            lblBillTotal.Text = "";
            string Office = "";
            foreach (ListItem item in ddlOffice.Items)
            {
