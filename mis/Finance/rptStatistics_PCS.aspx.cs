...
public partial class mis_Finance_rptStatistics_PCS : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void FillGridNextLedger(string Voucher_Name)
    {
        try
        {
            GridView1.DataSource = new string[] { };
            GridView1.DataBind();
            string headingFirst = "<p class='text-center' style='font-weight:600; text-align:center'> Statistics  <br /> M.P. State Minor Forest Produce(T & D)Co-op. Fed. Ltd, <br/> [ " + ddlOffice.SelectedItem.Text + " ] <br />  " + Convert.ToDateTime(txtFromDate.Text, cult).ToString("dd-MM-yyyy") + "  To " + Convert.ToDateTime(txtToDate.Text, cult).ToString("dd-MM-yyyy") + " <br/> Voucher Type : " + Voucher_Name + "</p>";
            ...
            if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
            {
                // string headingFirst = "<p class='text-center' style='font-weight:600'>Purchase Register <br /> M.P. State Minor Forest Produce(T & D)Co-op. Fed. Ltd, <br/> [ " + OfficeName + " ] <br /></p>";
