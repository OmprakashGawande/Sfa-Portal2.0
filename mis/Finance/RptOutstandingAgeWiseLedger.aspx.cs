...
public partial class mis_Finance_RptOutstandingAgeWiseLedger : System.Web.UI.Page
{
    ...
    protected void FillOutstandingBillWise(string Head_ID)
    {
        try
        {
            ...
            {
                ds = objdb.ByProcedure("SpFinRptOutstandingLedgers",
                   new string[] { "flag", "Office_ID_Mlt", "ToDate", "FromDate", "Head_ID", "BillType", "Ledger_ID", "str0Txn" },
                   new string[] { "9", Office, Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Head_ID, ddlBillType.SelectedValue.ToString(), ddlLedger.SelectedValue.ToString(), str0Txn }, "dataset");
            }
            else if (ddlBillType.SelectedValue.ToString() == "Dr")
            {
                ds = objdb.ByProcedure("SpFinRptOutstandingLedgers",
                   new string[] { "flag", "Office_ID_Mlt", "ToDate", "FromDate", "Head_ID", "BillType", "Ledger_ID", "str0Txn" },
                   new string[] { "10", Office, Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Head_ID, ddlBillType.SelectedValue.ToString(), ddlLedger.SelectedValue.ToString(), str0Txn }, "dataset");
            }
            else if (ddlBillType.SelectedValue.ToString() == "AllBill")
            {
                ds = objdb.ByProcedure("SpFinRptOutstandingLedgers",
                   new string[] { "flag", "Office_ID_Mlt", "ToDate", "FromDate", "Head_ID", "BillType", "Ledger_ID", "str0Txn" },
                   new string[] { "11", Office, Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Head_ID, ddlBillType.SelectedValue.ToString(), ddlLedger.SelectedValue.ToString(), str0Txn }, "dataset");
            }
            else if (ddlBillType.SelectedValue.ToString() == "ClearedBill")
            {
                ds = objdb.ByProcedure("SpFinRptOutstandingLedgers",
                   new string[] { "flag", "Office_ID_Mlt", "ToDate", "FromDate", "Head_ID", "BillType", "Ledger_ID", "str0Txn" },
                   new string[] { "17", Office, Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Head_ID, ddlBillType.SelectedValue.ToString(), ddlLedger.SelectedValue.ToString(), str0Txn }, "dataset");
            }
