                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-10">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>Item Rate <span style="color: red">(For E-Commerce)</span> </label>
                                    <asp:TextBox ID="txtItemRate" runat="server" placeholder="Item Rate" CssClass="form-control" MaxLength="6" ClientIDMode="Static" onkeypress="return validateDec(this, event);"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                        ...
                        <div class="col-md-2">
                            <div class="form-group text-center">
                                <label>Item Image<span style="color: red;"></span></label><br />
                            ...
                            <div class="form-group">
                                <asp:FileUpload ID="FUItemImage" runat="server" class="form-control" ClientIDMode="Static" onchange="UploadControlValidationForLenthAndFileFormat(100, 'JPEG*PNG*JPG', this),ValidateFileSize(this,1024*1024*1),previewProfileImage()" />
                            </div>
                        </div>
                    </div>
