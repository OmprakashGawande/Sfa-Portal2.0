...
public partial class mis_Finance_RptOutstandingAgeWise_New : System.Web.UI.Page
{
    DataSet ds, ds2, ds22;
    ...
    protected void FillDropdown()
    {
        try
        {
            ...
            ds = objdb.ByProcedure("SpFinRptOutstanding_New",
                   new string[] { "flag" },
            ...
            if (Office != "")
            {
                DataSet ds1 = objdb.ByProcedure("SpFinRptOutstanding_New",
                    new string[] { "flag", "Head_Id" },
                    new string[] { "17", "51" }, "dataset");
        ...
        try
        {
            ...
            if (Office != "")
            {
                DataSet ds1 = objdb.ByProcedure("SpFinRptOutstanding_New",
                      ...
                      new string[] { "18", ddlGroup.SelectedValue.ToString(), Office }, "dataset");
                if (ds1.Tables.Count != 0 && ds1.Tables[0].Rows.Count != 0)
                {
                    ddlLedger.DataSource = ds1;
                    ddlLedger.DataTextField = "Ledger_Name";
                    ...
                    ddlLedger.DataBind();
                    ddlLedger.SelectedIndex = 0;
                    ddlLedger.Items.Insert(0, new ListItem("All", "0"));
                    ddlLedger.SelectedIndex = 0;
                }
            }
        }
            ...
            if (ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                ...
                for (int i = 0; i < Count; i++)
                {
                    ...
                    if (TotalEntry > 1)
                    {
                        ...
                        ds2 = objdb.ByProcedure("SpFinRptOutstanding_New",
                        ...
                        if (ds2.Tables.Count > 0 && ds2.Tables[0].Rows.Count > 0)
                        {
                            ...
                            for (int p = 0; p < Count2; p++)
                            {
                                ...
                                if (ds2.Tables[0].Rows[p]["VoucherTx_Type"].ToString() == "CashSale Voucher" || ds2.Tables[0].Rows[p]["VoucherTx_Type"].ToString() == "GSTGoods Purchase" || ds2.Tables[0].Rows[p]["VoucherTx_Type"].ToString() == "DebitNote Voucher" || ds2.Tables[0].Rows[p]["VoucherTx_Type"].ToString() == "CreditNote Voucher" || ds2.Tables[0].Rows[p]["VoucherTx_Type"].ToString() == "CreditSale Voucher")
                                {
                                    ...
                                    ds22 = objdb.ByProcedure("SpFinRptOutstanding_New",
    ...
    protected void FillOutstandingBillPartyWise(string Head_ID)
    {
        try
        {
            ...
            {
                ds = objdb.ByProcedure("SpFinRptOutstanding_New",
                   new string[] { "flag", "Office_ID_Mlt", "ToDate", "FromDate", "Head_ID", "Ledger_ID" },
                   new string[] { "12", Office, Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Head_ID, ddlLedger.SelectedValue.ToString() }, "dataset");
            }
            else if (ddlBillType.SelectedValue.ToString() == "Dr")
            {
                ds = objdb.ByProcedure("SpFinRptOutstanding_New",
                   new string[] { "flag", "Office_ID_Mlt", "ToDate", "FromDate", "Head_ID", "Ledger_ID" },
                   new string[] { "13", Office, Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Head_ID, ddlLedger.SelectedValue.ToString() }, "dataset");
            }
            else if (ddlBillType.SelectedValue.ToString() == "AllBill")
            {
                ds = objdb.ByProcedure("SpFinRptOutstanding_New",
                   new string[] { "flag", "Office_ID_Mlt", "ToDate", "FromDate", "Head_ID", "Ledger_ID" },
                   new string[] { "14", Office, Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Head_ID, ddlLedger.SelectedValue.ToString() }, "dataset");
            }
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        if (Office != "")
        {
            ...
            {
                //headingFirst = "<p class='text-center' style='font-weight:600'>Payable Outstanding (Bill Wise) <br /> MP State Agro Industries Development Corporation, <br/> [ " + OfficeName + " ] <br />  " + Convert.ToDateTime(txtFromDate.Text, cult).ToString("dd-MM-yyyy") + "  To " + Convert.ToDateTime(txtToDate.Text, cult).ToString("dd-MM-yyyy") + "</p>";
            ...
            {
                //headingFirst = "<p class='text-center' style='font-weight:600'>Payable Outstanding (Bill Party Wise) <br /> MP State Agro Industries Development Corporation, <br/> [ " + OfficeName + " ] <br />  " + Convert.ToDateTime(txtFromDate.Text, cult).ToString("dd-MM-yyyy") + "  To " + Convert.ToDateTime(txtToDate.Text, cult).ToString("dd-MM-yyyy") + "</p>";
                headingFirst = "<p class='text-center' style='font-weight:600'>Outstanding (Bill Party Wise) <br /> MP State Agro Industries Development Corporation, <br/> [ " + OfficeName + " ] <br />  As On " + Convert.ToDateTime(txtToDate.Text, cult).ToString("dd-MM-yyyy") + "</p>";
            }

            lblheadingFirst.Text = headingFirst;

            if (ddlGroup.SelectedIndex > 0 && ddlLedger.SelectedIndex > 0)
            {
                if (ddlPartywise.SelectedValue.ToString() == "BillWise")
                {
    ...
    protected void ddlOutstandingType_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        else if (ddlOutstandingType.SelectedValue.ToString() == "Groups")
        {
            ...
            //    }
            //}
            //DataSet ds1 = objdb.ByProcedure("SpFinRptOutstanding_New", new string[] { "flag", "Office_ID_Mlt", "FromDate", "ToDate" }, new string[] { "19", Office, Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd") }, "dataset");
            //if (ds1.Tables.Count != 0 && ds1.Tables[0].Rows.Count != 0)
            //{
            //    ddlGroup.DataSource = ds1;
            //    ddlGroup.DataTextField = "Head_Name";
        ...
        try
        {
            ...
            if(ddlLedger.SelectedIndex > 0)
            {
                DataSet ds1 = objdb.ByProcedure("SpFinRptOutstanding_New",
                     ...
                     new string[] { "21", ddlLedger.SelectedValue.ToString() }, "dataset");
                if (ds1.Tables.Count != 0 && ds1.Tables[0].Rows.Count != 0)
                {
                    //ddlGroup.Items.FindByValue(ds1.Tables[0].Rows[0]["Head_ID"].ToString()).Selected = true;
    ...
    protected void ddlOffice_SelectedIndexChanged1(object sender, EventArgs e)
    {
        lblMsg.Text = "";
        lblHeadName.Text = "";
        lblheadingFirst.Text = "";
