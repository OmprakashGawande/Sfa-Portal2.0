    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box box-success">
                <div class="box-header Hiderow btnPrint">
                    <h3 class="box-title">Cash / Bank Book(s)</h3>
                    <asp:Button ID="btnPrint" runat="server" CssClass="btn btn-default pull-right hide_print" Text="Print" Style="margin-left: 10px;" OnClientClick="window.print();"></asp:Button>
                    <p class="hide_print">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div runat="server" id="divExcel">
                                <input type="button" class="no-print" onclick="tableToExcel('tableData', 'W3C Example Table')" value="Export to Excel">
                            </div>
                    ...
                    <div id="tableData">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <asp:GridView ID="GridView1" runat="server" ClientIDMode="Static" AutoGenerateColumns="false" class="table table-hover table-bordered" Style="margin-bottom: 0px;" OnRowCommand="GridView1_RowCommand" ShowFooter="true">
                                    <Columns>
                                ...
                                <%--LEDGER--%>
                                <asp:GridView ID="GridView2" runat="server" ClientIDMode="Static" AutoGenerateColumns="false" class="table table-hover table-bordered" OnRowCommand="GridView2_RowCommand" ShowFooter="true">
                                    <Columns>
                                        <asp:TemplateField HeaderText="SNo." ItemStyle-Width="10" Visible="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lblRowNumber" Text='<%# Container.DataItemIndex + 1 %>' runat="server" />
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <asp:GridView ID="GridView3" runat="server" ClientIDMode="Static" AutoGenerateColumns="false" class="table table-hover table-bordered" OnRowCommand="GridView3_RowCommand" ShowFooter="true">
                                    <Columns>
                                        <asp:TemplateField HeaderText="SNo." ItemStyle-Width="10" Visible="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lblRowNumber" Text='<%# Container.DataItemIndex + 1 %>' runat="server" />
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <asp:GridView ID="GridView4" runat="server" ClientIDMode="Static" AutoGenerateColumns="false" class="DailyDetaileddatatable table table-hover table-bordered" OnRowCommand="GridView4_RowCommand">
                                        <Columns>
                                            ...
                                            <asp:ButtonField ButtonType="Link" ControlStyle-CssClass="Aselect1" CommandName="View" HeaderText="Month Name" DataTextField="Date" />
                                            <asp:TemplateField HeaderText="Debit Amt." ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Right">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblDebitAmt" Text='<%# Eval("DebitAmt").ToString() %>' runat="server" />
                                                    <asp:Label ID="lblDate" CssClass="hidden" Visible="false" Text='<%# Eval("Date").ToString() %>' runat="server" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Credit Amt." ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Right">
                                                <ItemTemplate>
            ...
            <!--Bill By Bill Modal -->
            <div class="modal fade" id="DayWiseDetailModal" role="dialog">
                <div class="modal-dialog modal-lg">
                    <!-- Modal content-->
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title">Day Wise Details </h4>
                            <input type="button" onclick="tableToExcel('DivDayTable', 'W3C Example Table')" class="btn btn-default pull-right hide_print" value="Excel" />

                        </div>
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div id="DivDayTable" runat="server" clientidmode="static"></div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentFooter" runat="Server">
    ...
    <script>
        function ShowDayWiseDetailModal() {
            $('#DayWiseDetailModal').modal('show');
