        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-md-12">
					...
					<label class="text-danger" style="padding-top:10px; font-size:13px;">** नोट :- संघ मुख्यालय आय मद हेतु “हेड़ कोड क्र. 50 से 61 “ तक निर्धारित किये गए है, आय हेतु केवल निर्धारित हेड़ कोड का ही उपयोग किया जावे |क्रेता या विक्रेता का लेज़र केवल कास्ट सेंटर में ही उपयोग किया जावेगा</label>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                               Create Voucher Against Transaction Failed Payment Voucher&nbsp;&nbsp;&nbsp;<asp:CheckBox ID="chkboxreverse" runat="server" OnCheckedChanged="chkboxreverse_CheckedChanged" AutoPostBack="true" />
                            </div>
                        </div>
                    </div>
                            <asp:Label ID="lblVoucherTx_Ref" runat="server" Visible="false" ></asp:Label>
                            <div class="row" id="divVoucherRef" runat="server" visible="false">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <asp:Button ID="btnVoucherRefSearch" runat="server" Text="Search" CssClass="btn btn-success btn-block" Style="margin-top: 25px;"  OnClick="btnVoucherRefSearch_Click"/>
                                        </div>
                                    </div>
                                    <%--<div class="col-md-4 pull-left">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date">
                                                ...
                                                <asp:TextBox ID="txtVoucherTxDate" runat="server" CssClass="form-control DateAdd" placeholder="Ref. Voucher Date..." autocomplete="off"></asp:TextBox>
                                            </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6" style="margin-left: -32px;">
                                            <asp:TextBox runat="server" CssClass="form-control NameNumslashhyphenOnly" ID="txtVoucherTx_No" placeholder="Enter Voucher No..." ClientIDMode="Static" MaxLength="10" autocomplete="off"></asp:TextBox>
                                                ...
                                                <asp:GridView runat="server" CssClass="table table-bordered" DataKeyNames="RowNo" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False" ID="GridViewLedgerDetail" ShowFooter="True" OnSelectedIndexChanged="GridViewLedgerDetail_SelectedIndexChanged" OnRowDeleting="GridViewLedgerDetail_RowDeleting">
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Bill By Bill Detail" ShowHeader="False">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" CommandName="Select" Text='<%# Eval("LedgerTx_MaintainType").ToString()=="None"?"NA":"View" %>' CssClass="label label-info" OnClick="lnkbtnView_Click"></asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox runat="server" ID="txtVoucherTx_Narration" TextMode="MultiLine" Rows="18" ClientIDMode="Static" CssClass="form-control"></asp:TextBox>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <a href="VoucherReceiptD.aspx" id="btnClear" runat="server" class="btn btn-block btn-default">Clear</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="table-responsive">
                                <asp:GridView runat="server" CssClass="table table-bordered" ShowHeaderWhenEmpty="true" ID="GVFinChequeTx" AutoGenerateColumns="false" ClientIDMode="Static">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Cheque/ DD No/NEFT/RTGS">
                                            <ItemTemplate>
