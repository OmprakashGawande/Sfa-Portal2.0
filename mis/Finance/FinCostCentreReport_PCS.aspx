<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="FinCostCentreReport_PCS.aspx.cs" Inherits="mis_Finance_FinCostCentreReport_PCS" %>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="ddlOffice" ClientIDMode="Static" CssClass="form-control select2" runat="server"></asp:DropDownList>
