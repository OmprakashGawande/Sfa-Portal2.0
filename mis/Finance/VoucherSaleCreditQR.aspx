<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="VoucherSaleCreditQR.aspx.cs" Inherits="mis_Finance_VoucherSaleCreditQR" %>
                            ...
                            <asp:Panel ID="panel1" runat="server">
                                ...
                                <asp:Panel ID="pnlitem" ClientIDMode="Static" runat="server">
                                    <fieldset>
                                        ...
                                        <!-- ItemDetail GridView-->
                                        <asp:GridView ID="GridViewItem" runat="server" DataKeyNames="ID,ItemID" ClientIDMode="Static" class="table table-bordered customCSS" Style="margin-bottom: 0px;" AutoGenerateColumns="False" ShowHeaderWhenEmpty="true" OnRowDeleting="GridViewItem_RowDeleting" ShowFooter="true">
                                            <Columns>
                            ...
                            <asp:Panel ID="panel2" runat="server">
                                <div class="row">
                                    ...
                                    <!--<div class="col-md-2">
                                        <div class="form-group">
                                            <label>MR No.</label>
                                            <asp:TextBox runat="server" ID="txtVoucherTx_MRNo" CssClass="form-control" ClientIDMode="Static" autocomplete="off"></asp:TextBox>
                                            <small><span id="valtxtVoucherTx_MRNo" style="color: red;"></span></small>
                                        </div>
                                    </div>--->
                ...
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="Heading_SubItemModal">
                                    ...
                                    <div class="col-md-2">
                                        <b>Amount: </b>
                                        <asp:Label ID="lblSubItem_amount" runat="server" Text=""></asp:Label>
                                    </div>
                                    <br />
                                    <br />
                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView runat="server" CssClass="table table-bordered" ShowHeaderWhenEmpty="true" ID="GVFinItemIngredientTx" AutoGenerateColumns="false" ClientIDMode="Static">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Quantity">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtSubItem_Quantity" runat="server" Text='<%# Eval("Ingredient_Size") %>' CssClass="form-control txtQuantity" placeholder=""></asp:TextBox>
                                                        <asp:Label ID="lblSubItem_Unit" Text='<%# Eval("Ingredient_Unit") %>' runat="server" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Rate">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtSubItem_Rate" runat="server" Text='0' CssClass="form-control"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Amount">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtSubItem_Amount" runat="server" Text='0' CssClass="form-control"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
                        ...
                        <div class="modal-footer">
                            ...
                            <asp:Button ID="btnAddSubItem" runat="server" CssClass="btn btn-flat btn-info" Text="Add Sub Items" OnClick="btnAddSubItem_Click" OnClientClick="return validateSubitemItem();" />
