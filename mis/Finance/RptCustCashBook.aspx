<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RptCustCashBook.aspx.cs" Inherits="mis_Finance_RptCustCashBook" EnableEventValidation="false" %>
        ...
        <section class="content">
            <div class="box box-success">
                <div class="box-header Hiderow">
                    <h3 class="box-title">Custom Cash Book</h3>
					<p class="hide_print">
                    ...
                    <div id="tableData">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="col-xs-3">
                                    <div class="form-group">  
                                        <asp:Label ID="txtAllBankOpening" runat="server" Text="" style="font-size:17px;"></asp:Label>
                                    </div>
                                    
                                </div>
                                 <div class="col-xs-3 pull-right">
                                     <div class="form-group">
                                          <asp:Label ID="txtAllBankClosing" runat="server" style="font-size:17px;"></asp:Label>
                                     </div>
                                        ...
                                        <asp:TemplateField HeaderText="Particulars">
                                            <ItemTemplate>
                                                <asp:Label ID="lblLedger_Name" Text='<%# Eval("Ledger_Name").ToString() %>' runat="server" />
												  <div class="HideRecord"><span><%# Eval ("Variable") %></span></div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
