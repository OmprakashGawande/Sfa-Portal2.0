                ...
                <div class="col-md-12">
                    <div class="box box-success">
                        <div class="box-header">
                            <h3 class="box-title">Your office Ledgers (All)</h3><asp:HyperLink ID="lnkotherledger"  runat="server"  NavigateUrl="LedgerDetailOther.aspx" Target="_blank" CssClass="btn btn-primary pull-right hidden">Other Office Ledgers (Only Sundry Creditors)</asp:HyperLink>
