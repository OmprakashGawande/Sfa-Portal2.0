...
public partial class mis_Finance_RptTrialBalanceOpen : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void GridView2_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            ...
            if (e.CommandName == "ViewBill")
            {
                ...
                ds = objdb.ByProcedure("SpFinRptTrialBalanceNewF", new string[] { "flag", "Ledger_ID", "Office_ID_Mlt", "FromDate", "ToDate" }, new string[] { "15", Ledger_ID, Office, Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd") }, "dataset");
