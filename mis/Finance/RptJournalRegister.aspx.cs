...
public partial class mis_Finance_RptJournalRegister : System.Web.UI.Page
{
    ...
    protected void FillGridNextLedger()
    {
        try
        {
            ...
            if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
            {
                string headingFirst = "<p class='text-center' style='font-weight:600'>Journal Register <br /> MP State Agro Industries Development Corporation, <br/> [ " + OfficeName + " ] <br /></p>";
        ...
        try
        {
          ...
          //  GridView4.DataSource = null;
           ...
           // ds = objdb.ByProcedure("SpFinRptJournalRegister", new string[] { "flag", "Office_ID_Mlt", "VoucherTx_Name", "LedgerTx_Month", "FromDate", "ToDate" }, new string[] { "4", Office, "Journal,Journal HO", MonthID, Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd") }, "dataset");
            ds = objdb.ByProcedure("SpFinRptJournalRegister", new string[] { "flag", "Office_ID_Mlt", "VoucherTx_Name", "LedgerTx_Month", "FromDate", "ToDate", "FinancialYear" }, new string[] { "7", Office, "Journal,Journal HO", MonthID, Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd"), FinancialYear }, "dataset");
            if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
            {
                string headingFirst = "<p class='text-center' style='font-weight:600'>Journal Register <br /> MP State Agro Industries Development Corporation, <br/> [ " + OfficeName + " ] <br /></p>";
                lblHeading.Text = headingFirst;
        ...
        try
        {
            ...
            if (e.CommandName == "View")
            {
                ...
                if (lblDebitAmt.Text != "0")
                {
                   ...
                   // lblHeading.Text = "Journal Register";
