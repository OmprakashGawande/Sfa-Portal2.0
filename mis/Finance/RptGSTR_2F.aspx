<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RptGSTR_2F.aspx.cs" Inherits="mis_Finance_RptGSTR_2F" %>
        ...
        <section class="content">
            ...
            <div class="box box-success">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <asp:Panel ID="DivTable" runat="server">
                                <label  class="hide_print">Export Excel</label>
                                <br />
                             ...
                             <%--<asp:Button ID="btnEB2BVoucher" runat="server" Text="B2B" OnClick="btnEB2BVoucher_Click" />
                                ...
                                <div style="background: #ffe6c8; padding: 5px;">
                                    <table style="width: 100%; margin-bottom: 0px;" class="table table-hover no-border">
                                        <tr>
                                            <td style="font-weight: bold; border-top: 1px solid #000;" colspan="8">GSTIN/UIN: </td>
					...
					<tr>
                                            <td>
                                                <asp:LinkButton ID="btnHSNItemWiseSummary" runat="server" OnClick="btnHSNItemWiseSummary_Click"> HSN/SAC Item Wise Summary - 13</asp:LinkButton></td>
                                            <td style="text-align: center;"></td>
                                           <%-- <td style="text-align: center;">1195254.55</td>
                                            <td style="text-align: center;">1195254.55</td>
                                            <td style="text-align: center;">1195254.55</td>
                                            ...
                                            <td style="text-align: center;"></td>--%>
                                            <td style="text-align: center; font-weight: bold;">
                                                <asp:Label ID="lblHSNTaxableValue_ItemWise" runat="server" Text=""></asp:Label></td>
                                            <td style="text-align: center; font-weight: bold;">
                                                <asp:Label ID="lblHSNTIntegratedTax_ItemWise" runat="server" Text=""></asp:Label></td>
                                            <td style="text-align: center; font-weight: bold;">
                                                <asp:Label ID="lblHSNTCentarlTax_ItemWise" runat="server" Text=""></asp:Label></td>
                                            <td style="text-align: center; font-weight: bold;">
                                                <asp:Label ID="lblHSNTStateTax_ItemWise" runat="server" Text=""></asp:Label></td>
                                            <td style="text-align: center; font-weight: bold;">
                                                <asp:Label ID="lblHSNTCessAmt_ItemWise" runat="server" Text=""></asp:Label></td>
                                            <td style="text-align: center;"></td>
                                            <td style="text-align: center;"></td>
                                            <td style="text-align: center;"></td>
                                            <td style="text-align: center;"></td>
				...
				<asp:GridView ID="GridHSNSummery_ItemWise" runat="server" AutoGenerateColumns="false" class="table table-hover table-bordered" OnRowCommand="GridHSNSummery_ItemWise_RowCommand"  ShowFooter="true">
                                <Columns>
                                    <asp:TemplateField HeaderText="SNo." ItemStyle-Width="5%">
                                        <ItemTemplate>
                                            <asp:Label ID="lblRowNumber" Text='<%# Container.DataItemIndex + 1 %>' runat="server" />
