                                    ...
                                    <div class="col-md-3 pull-right">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date">
                                                ...
                                                <asp:TextBox ID="txtVoucherTx_Date" runat="server" CssClass="form-control DateAdd" placeholder="Enter Voucher Date..." autocomplete="off" AutoPostBack="true" OnTextChanged="txtVoucherTx_Date_TextChanged"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Rate Per">
                                                                ...
                                                                <ItemTemplate>
                                                                   <%-- <asp:Label ID="lblRate" runat="server" Text='<%# Eval("Rate").ToString()%>'></asp:Label>--%>
                                                                    <asp:TextBox ID="lblRate" runat="server" CssClass="form-control control1" Text='<%# Eval("Rate").ToString()%>'  MaxLength="12" onkeypress="return validateDec(this,event);" onfocusout="CalculateGridAmount()" OnTextChanged="txtQuantity_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                            ...
                                                            <asp:TemplateField HeaderText="Amount ">
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:TextBox ID="txtAmountH" runat="server" CssClass="form-control control1" Text='<%# Eval("Amount").ToString()%>' onchange="CalculateGridAmount()"></asp:TextBox>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
