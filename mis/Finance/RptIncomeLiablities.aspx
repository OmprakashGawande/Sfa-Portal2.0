<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RptIncomeLiablities.aspx.cs" Inherits="mis_Finance_RptIncomeLiablities" EnableEventValidation="false" %>
        ...
        <section class="content">
            <div class="box box-success">
                <div class="box-header hide_print">
                    <h3 class="box-title">प्राप्ति का विवरण</h3>
                ...
                <div class="box-body">
                    ...
                    <div class="row hide_print">
                        <div class="col-md-2">
                            <div class="form-group">
                                <asp:Button ID="btnSearch" runat="server" Text="Search" CssClass="btn btn-success btn-block" OnClick="btnSearch_Click" OnClientClick="return validateform();" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div id="tableData">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <asp:GridView ID="gvData" runat="server" ClientIDMode="Static" AutoGenerateColumns="false" class="table table-hover table-bordered" ShowFooter="true" OnRowCommand="gvData_RowCommand">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="गत माह तक आय	">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="वर्तमान माह में प्राप्त आय">
                                            <ItemTemplate>
                                                <asp:Label ID="lblCurrentTxn" runat="server" Text='<%# Eval("CurrentTxn") %>' Font-Bold='<%# Eval("Ledger_ID").ToString()==""?true:false %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="कुल प्राप्त आय">
                                            <ItemTemplate>
                                                <asp:Label ID="lblTotal" runat="server" Text='<%# Eval("Total") %>' Font-Bold='<%# Eval("Ledger_ID").ToString()==""?true:false %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentFooter" runat="Server">
    ...
    <script>
        ...
        //    window.print();
        //}
        function GetMonthData(Ledger_ID) {

            var LID = Ledger_ID

            $.ajax({

                url: '<%=ResolveUrl("RptIncomeLiablities.aspx/GetMonthData") %>',
