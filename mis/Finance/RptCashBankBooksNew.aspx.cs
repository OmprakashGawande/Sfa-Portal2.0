...
public partial class mis_Finance_RptCashBankBooksNew : System.Web.UI.Page
{
    ...
    protected void FillGridNext(string Head_ID)
    {
        try
        {
            ...
            {
                lblHeadName.Text = "<p class='text-center' style='font-weight:600'>" + ds1.Tables[0].Rows[0]["Head_Name"].ToString() + " </p>";
            }
    ...
    protected void FillGridNextLedger(string Ledger_ID)
    {
        try
        {
            ...
            if (ds1.Tables.Count != 0 && ds1.Tables[0].Rows.Count != 0)
            {
                lblHeadName.Text = "<p class='text-center' style='font-weight:600'>" + ds1.Tables[0].Rows[0]["Ledger_Name"].ToString() + "";
            }
            GridView3.DataSource = new string[] { };
            GridView3.DataBind();
            string Office = "";
            ...
            if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
            {
                ...
                if (chkOpeningBal.Checked == true)
                {
                    if ((decimal.Parse(ViewState["Bal"].ToString())) < 0)
                    {
                        lblHeadName.Text = "<p class='text-center' style='font-weight:600'>" + lblHeadName.Text + "<span style='color:#d03535;'> Opening Bal. : " + Math.Abs(decimal.Parse(ViewState["Bal"].ToString())).ToString() + " Dr </span></p>";
                    }
                    else
                    {
                        lblHeadName.Text = "<p class='text-center' style='font-weight:600'>" + lblHeadName.Text + "<span style='color:#d03535;'> Opening Bal. : " + Math.Abs(decimal.Parse(ViewState["Bal"].ToString())).ToString() + " Cr </span></p>";
                    }
                }
                //09Jun2020 End
                int rowcount = ds.Tables[0].Rows.Count;
    ...
    protected void FillGridNextLedgerMonth(string Ledger_ID, string MonthID)
    {
        try
        {
            ...
            if (ds1.Tables.Count != 0 && ds1.Tables[0].Rows.Count != 0)
            {
                ...
                lblHeadName.Text = "<p class='text-center' style='font-weight:600'>" + ds1.Tables[0].Rows[0]["Ledger_Name"].ToString() + "( Month : " + mfi.GetMonthName(int.Parse(MonthID)).ToString() + " )</p>";
            }
            ...
            //  ds = objdb.ByProcedure("SpFinRptCashBankBooksNew", new string[] { "flag", "Office_ID_Mlt", "Ledger_ID", "LedgerTx_Month", "FromDate", "ToDate" }, new string[] { "6", Office, Ledger_ID, MonthID, Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd") }, "dataset");
            ...
            if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
            {
                ...
                for (int i = 0; i < Count; i++)
                {
                    ...
                    // Inner Transaction
                    ds1 = null;
                    ds1 = objdb.ByProcedure("SpFinRptCashBankBooksNew", new string[] { "flag", "VoucherTx_ID", "Ledger_ID", }, new string[] { "12", ds.Tables[0].Rows[i]["VoucherTx_ID"].ToString(), Ledger_ID }, "dataset");
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        if (Office != "")
        {
            ...
            string headingFirst = "<p class='text-center' style='font-weight:600'>Cash / Bank Book(s) <br /> SFA Technologies Pvt. Ltd. <br/> [ " + OfficeName + " ] <br />  " + Convert.ToDateTime(txtFromDate.Text, cult).ToString("dd-MM-yyyy") + "  To " + Convert.ToDateTime(txtToDate.Text, cult).ToString("dd-MM-yyyy") + "</p>";
            ...
            if (ViewState["DayBookVisible"].ToString() == "true")
            {
                ...
                if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
                {
                    ...
                    for (int i = 1; i < rowcount; i++)
                    {
                        ...
                        if (OpeningBal >= 0)
                        {
                            GridView4.Rows[i].Cells[3].Text = "<span style='color:red;'>" + OpeningBal.ToString() + " Cr</span>";
    ...
    protected void GridView4_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            ...
            if (e.CommandName == "View")
            {
                ...
                if (lblDate.Text != "Opening Balance")
                {
                    ...
                    DivDayTable.InnerHtml = "";
                    ds = objdb.ByProcedure("SpFinRptTrialBalanceNewF",
                        new string[] { "flag", "Office_ID_Mlt", "Ledger_ID", "FromDate", "FinancialYear" },
                        new string[] { "17", Office, Ledger_ID, Convert.ToDateTime(lblDate.Text, cult).ToString("yyyy/MM/dd"), FinancialYear }, "dataset");
                    if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
                    {
                        ...
                        DivDayTable.InnerHtml = htmlStr.ToString();

                    }
                    #endregion
                    Page.ClientScript.RegisterStartupScript(this.GetType(), "CallMyFunction", "ShowDayWiseDetailModal();", true);
                }
            }
