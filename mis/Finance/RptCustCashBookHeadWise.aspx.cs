...
public partial class mis_Finance_RptCustCashBookHeadWise : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void FillGrid()
    {
        try
        {
            ...
            if (ds.Tables.Count != 0 && ds.Tables.Count != 0)
            {
                ...
                string headingFirst = "<p class='text-center' style='font-weight:600; text-align:center'>Head Wise Cash Book<br /> SFA Technologies Pvt. Ltd.   <br/> [ " + ddlOffice.SelectedItem.Text + " ] <br />  " + Convert.ToDateTime(txtFromDate.Text, cult).ToString("dd-MM-yyyy") + "  To " + Convert.ToDateTime(txtToDate.Text, cult).ToString("dd-MM-yyyy") + "</p>";
