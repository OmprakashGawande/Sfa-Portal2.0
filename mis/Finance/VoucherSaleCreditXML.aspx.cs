...
public partial class mis_Finance_VoucherSaleCreditXML : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void ddlItemName_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                ds = objdb.ByProcedure("SpItemMaster",
                        new string[] { "flag", "ItemId", "Office_ID" },
                        new string[] { "26", ddlItemName.SelectedValue.ToString(), ViewState["Office_ID"].ToString() }, "dataset");
                if (ds.Tables[0].Rows.Count != 0)
                {
                    lblUnit.Text = ds.Tables[0].Rows[0]["NoOfDecimalPlace"].ToString();
        ...
        try
        {
            ...
            if (msg == "")
            {
                ...
                if (btnAccept.Text == "Accept" && ViewState["VoucherTx_ID"].ToString() == "0" && Status == 0)
                {
                    ...
                    ds = objdb.ByProcedure("SpFinVoucherTx", new string[] { "flag", "VoucherTx_Date", "VoucherTx_Name", "VoucherTx_Type", "VoucherTx_No", "VoucherTx_Ref", "VoucherTx_Narration", "VoucherTx_Amount", "VoucherTx_Month", "VoucherTx_Year", "Office_ID", "VoucherTx_FY", "VoucherTx_IsActive", "VoucherTx_InsertedBy", "VoucherTx_SalesCenterID", "SchemeTx_ID", "VoucherTx_SoldTo", "VoucherTx_OrderNo", "VoucherTx_RegNo", "VoucherTx_OrderDate", "GSTVoucher" }
                    ...
                    if (ds != null && ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        string XmlStr = "<XML_LedgerSet>";
                        string XmlItemTx = "<XML_ItemTxSet>";
                        string XmlInventoryAffected = "<XML_InventoryAffected>";

                        int ledgercount = 0;
                        int InventoryAffectedCount = 0;
                        for (rowItemIndex = 0; rowItemIndex < gridItemRows; rowItemIndex++)
                        {
                            ...
                            //objdb.ByProcedure("SpFinItemTx", new string[] { "flag", "VoucherTx_ID", "VoucherTx_Name", "VoucherTx_Type", "Ledger_ID"
                            //    , "Item_id", "Unit_id", "Quantity", "Rate", "Amount", "HSN_Code", "IGST_Per", "CGST_Per", "SGST_Per", "CGSTAmt", "SGSTAmt", "IGSTAmt"
                            //    , "Warehouse_id", "Office_ID", "ItemTx_FY", "ItemTx_IsActive", "ItemTx_InsertedBy", "ItemTx_OrderBy", "Taxbility" }
                            //    , new string[] { "0", VoucherTx_ID, "Sales Voucher", "CreditSale Voucher", lblLedgerID.Text
                            //        , lblItemID.Text, lblUnit_id.Text, lblQuantity.Text, lblRate.Text, lblAmount.Text, lblHSNCode.Text, lblIGSTPer.Text, lblCGSTPer.Text
                            //        , lblSGSTPer.Text, lblCGST.Text, lblSGST.Text, lblIGST.Text, ddlWarehouse.SelectedValue.ToString(), ViewState["Office_ID"].ToString()
                            //        , FinancialYear.ToString(), ItemTx_IsActive, ViewState["Emp_ID"].ToString(), lblItemRowNo.Text, lblTaxbility.Text }, "dataset");
                            ledgercount = 1;

                            XmlItemTx += "<row>";
                            XmlItemTx += "<VoucherTx_ID>" + VoucherTx_ID + "</VoucherTx_ID>";
                            XmlItemTx += "<VoucherTx_Name>" + "Sales Voucher" + "</VoucherTx_Name>";
                            XmlItemTx += "<VoucherTx_Type>" + "CreditSale Voucher" + "</VoucherTx_Type>";
                            XmlItemTx += "<Ledger_ID>" + lblLedgerID.Text + "</Ledger_ID>";
                            XmlItemTx += "<Item_id>" + lblItemID.Text + "</Item_id>";
                            XmlItemTx += "<Unit_id>" + lblUnit_id.Text + "</Unit_id>";
                            XmlItemTx += "<Quantity>" + lblQuantity.Text + "</Quantity>";
                            XmlItemTx += "<Rate>" + lblRate.Text + "</Rate>";
                            XmlItemTx += "<Amount>" + lblAmount.Text + "</Amount>";
                            XmlItemTx += "<HSN_Code>" + lblHSNCode.Text + "</HSN_Code>";
                            XmlItemTx += "<IGST_Per>" + lblIGSTPer.Text + "</IGST_Per>";
                            XmlItemTx += "<CGST_Per>" + lblCGSTPer.Text + "</CGST_Per>";
                            XmlItemTx += "<SGST_Per>" + lblSGSTPer.Text + "</SGST_Per>";
                            XmlItemTx += "<CGSTAmt>" + lblCGST.Text + "</CGSTAmt>";
                            XmlItemTx += "<SGSTAmt>" + lblSGST.Text + "</SGSTAmt>";
                            XmlItemTx += "<IGSTAmt>" + lblIGST.Text + "</IGSTAmt>";
                            XmlItemTx += "<Warehouse_id>" + ddlWarehouse.SelectedValue.ToString() + "</Warehouse_id>";
                            XmlItemTx += "<Office_ID>" + ViewState["Office_ID"].ToString() + "</Office_ID>";
                            XmlItemTx += "<ItemTx_FY>" + FinancialYear.ToString() + "</ItemTx_FY>";
                            XmlItemTx += "<ItemTx_IsActive>" + ItemTx_IsActive + "</ItemTx_IsActive>";
                            XmlItemTx += "<ItemTx_InsertedBy>" + ViewState["Emp_ID"].ToString() + "</ItemTx_InsertedBy>";
                            XmlItemTx += "<ItemTx_OrderBy>" + lblItemRowNo.Text + "</ItemTx_OrderBy>";
                            XmlItemTx += "<Taxbility>" + lblTaxbility.Text + "</Taxbility>";
                            XmlItemTx += "</row>";
                            ...
                            if (ds != null && ds.Tables[0].Rows.Count > 0)
                            {
                                if (ds.Tables[0].Rows[0]["InventoryAffected"].ToString() == "Yes")
                                {
                                    ...
                                    //    new string[] { "flag", "Item_id", "Cr", "Dr", "Rate", "TransactionID", "TransactionFrom", "InvoiceNo", "Office_Id"
                                    //                    , "Warehouse_id", "CreatedBy", "TranDt", "Amount" }
                                    //   , new string[] { "4", lblItemID.Text, "0", lblQuantity.Text, lblRate.Text, VoucherTx_ID, "CreditSale Voucher", VoucherTx_No
                                    //       , ViewState["Office_ID"].ToString(), lblWarehouse_id.Text, ViewState["Emp_ID"].ToString(), Convert.ToDateTime(txtVoucherTx_Date.Text, cult).ToString("yyyy/MM/dd"), lblAmount.Text }, "dataset");

                                    InventoryAffectedCount = 1;

                                    XmlInventoryAffected += "<row>";
                                    XmlInventoryAffected += "<Item_id>" + lblItemID.Text + "</Item_id>";
                                    XmlInventoryAffected += "<Cr>" + "0" + "</Cr>";
                                    XmlInventoryAffected += "<Dr>" + lblQuantity.Text + "</Dr>";
                                    XmlInventoryAffected += "<Rate>" + lblRate.Text + "</Rate>";
                                    XmlInventoryAffected += "<TransactionID>" + VoucherTx_ID + "</TransactionID>";
                                    XmlInventoryAffected += "<TransactionFrom>" + "CreditSale Voucher" + "</TransactionFrom>";
                                    XmlInventoryAffected += "<InvoiceNo>" + VoucherTx_No + "</InvoiceNo>";
                                    XmlInventoryAffected += "<Office_Id>" + ViewState["Office_ID"].ToString() + "</Office_Id>";
                                    XmlInventoryAffected += "<Warehouse_id>" + lblWarehouse_id.Text + "</Warehouse_id>";
                                    XmlInventoryAffected += "<CreatedBy>" + ViewState["Emp_ID"].ToString() + "</CreatedBy>";
                                    XmlInventoryAffected += "<TranDt>" + Convert.ToDateTime(txtVoucherTx_Date.Text, cult).ToString("yyyy/MM/dd") + "</TranDt>";
                                    XmlInventoryAffected += "<Amount>" + lblAmount.Text + "</Amount>";
                                    XmlInventoryAffected += "</row>";
                                }
                            }
                            //objdb.ByProcedure("SpFinLedgerTx",
                            //    new string[] { "flag", "Ledger_ID", "LedgerTx_Type", "VoucherTx_ID", "Item_id", "VoucherTx_Type", "LedgerTx_Amount", "LedgerTx_Month", "LedgerTx_Year"
                            //        , "LedgerTx_FY", "Office_ID", "LedgerTx_IsActive", "LedgerTx_InsertedBy", "LedgerTx_OrderBy" },
                            //    new string[] { "0", lblLedgerID.Text, "Item Ledger", VoucherTx_ID, lblItemID.Text, "CreditSale Voucher"
                            //        , lblAmount.Text, Month.ToString(), Year.ToString(), FinancialYear.ToString(), ViewState["Office_ID"].ToString(), LedgerTx_IsActive, ViewState["Emp_ID"].ToString(), lblItemRowNo.Text }, "dataset");

                            XmlStr += "<row>";
                            XmlStr += "<Ledger_ID>" + lblLedgerID.Text + "</Ledger_ID>";
                            XmlStr += "<LedgerTx_Type>" + "Item Ledger" + "</LedgerTx_Type>";
                            XmlStr += "<VoucherTx_ID>" + VoucherTx_ID + "</VoucherTx_ID>";
                            XmlStr += "<Item_id>" + lblItemID.Text + "</Item_id>";
                            XmlStr += "<VoucherTx_Type>" + "CreditSale Voucher" + "</VoucherTx_Type>";
                            XmlStr += "<LedgerTx_Amount>" + lblAmount.Text + "</LedgerTx_Amount>";
                            XmlStr += "<LedgerTx_Month>" + Month.ToString() + "</LedgerTx_Month>";
                            XmlStr += "<LedgerTx_Year>" + Year.ToString() + "</LedgerTx_Year>";
                            XmlStr += "<LedgerTx_FY>" + FinancialYear.ToString() + "</LedgerTx_FY>";
                            XmlStr += "<Office_ID>" + ViewState["Office_ID"].ToString() + "</Office_ID>";
                            XmlStr += "<LedgerTx_IsActive>" + LedgerTx_IsActive + "</LedgerTx_IsActive>";
                            XmlStr += "<LedgerTx_InsertedBy>" + ViewState["Emp_ID"].ToString() + "</LedgerTx_InsertedBy>";
                            XmlStr += "<LedgerTx_OrderBy>" + lblItemRowNo.Text + "</LedgerTx_OrderBy>";
                            XmlStr += "<VoucherTx_Date>" + Convert.ToDateTime(txtVoucherTx_Date.Text, cult).ToString("yyyy/MM/dd") + "</VoucherTx_Date>";
                            XmlStr += "</row>";

                        }
                        XmlItemTx += "</XML_ItemTxSet>";
                        XmlStr += "</XML_LedgerSet>";
                        XmlInventoryAffected += "</XML_InventoryAffected>";
                        if (ledgercount == 1)
                        {
                            objdb.ByProcedure("SpFinLedgerTx",
                               new string[] { "flag", "XmlStr", "XmlItemTx", "XmlInventoryAffected", "InventoryAffectedCount" },
                               new string[] { "12", XmlStr, XmlItemTx, XmlInventoryAffected, InventoryAffectedCount.ToString() }, "dataset");

                        }
                        int gridRows = GridViewLedger.Rows.Count;

                        string Xml_LedgerTx = "<Xml_LedgerTx>";
                        ...
                        for (int rowIndex = 0; rowIndex < gridRows; rowIndex++)
                        {
                            ...
                            //objdb.ByProcedure("SpFinLedgerTx",
                            //new string[] { "flag", "Ledger_ID", "LedgerTx_Type", "VoucherTx_ID", "VoucherTx_Type", "LedgerTx_Amount", "LedgerTx_Month"
                            //    , "LedgerTx_Year", "LedgerTx_FY", "Office_ID", "LedgerTx_IsActive", "LedgerTx_InsertedBy", "LedgerTx_OrderBy"
                            //    , "HSN_Code", "CGST_Per", "SGST_Per", "IGST_Per", "CGSTAmt", "SGSTAmt", "IGSTAmt", "GSTApplicable", "Taxbility" },
                            //new string[] { "0", lblID.Text, "Sub Ledger", VoucherTx_ID, "CreditSale Voucher", txtAmount.Text, Month.ToString(), Year.ToString()
                            //    , FinancialYear.ToString(), ViewState["Office_ID"].ToString(), LedgerTx_IsActive, ViewState["Emp_ID"].ToString(), (rowIndex + 1).ToString()
                            //    , lblHSNCode.Text, lblCGSTPer.Text, lblSGSTPer.Text, lblIGSTPer.Text, lblCGSTAmt.Text, lblSGSTAmt.Text, lblIGSTAmt.Text
                            //    , lblGSTApplicable.Text, lblTaxbility.Text }, "dataset");

                            ledgertxcount = 1;

                            Xml_LedgerTx += "<row>";
                            Xml_LedgerTx += "<Ledger_ID>" + lblID.Text + "</Ledger_ID>";
                            Xml_LedgerTx += "<LedgerTx_Type>" + "Sub Ledger" + "</LedgerTx_Type>";
                            Xml_LedgerTx += "<VoucherTx_ID>" + VoucherTx_ID + "</VoucherTx_ID>";
                            Xml_LedgerTx += "<VoucherTx_Type>" + "CreditSale Voucher" + "</VoucherTx_Type>";
                            Xml_LedgerTx += "<LedgerTx_Amount>" + txtAmount.Text + "</LedgerTx_Amount>";
                            Xml_LedgerTx += "<LedgerTx_Month>" + Month.ToString() + "</LedgerTx_Month>";
                            Xml_LedgerTx += "<LedgerTx_Year>" + Year.ToString() + "</LedgerTx_Year>";
                            Xml_LedgerTx += "<LedgerTx_FY>" + FinancialYear.ToString() + "</LedgerTx_FY>";
                            Xml_LedgerTx += "<Office_ID>" + ViewState["Office_ID"].ToString() + "</Office_ID>";
                            Xml_LedgerTx += "<LedgerTx_IsActive>" + LedgerTx_IsActive + "</LedgerTx_IsActive>";
                            Xml_LedgerTx += "<LedgerTx_InsertedBy>" + ViewState["Emp_ID"].ToString() + "</LedgerTx_InsertedBy>";
                            Xml_LedgerTx += "<LedgerTx_OrderBy>" + (rowIndex + 1).ToString() + "</LedgerTx_OrderBy>";
                            Xml_LedgerTx += "<HSN_Code>" + lblHSNCode.Text + "</HSN_Code>";
                            Xml_LedgerTx += "<CGST_Per>" + lblCGSTPer.Text + "</CGST_Per>";
                            Xml_LedgerTx += "<SGST_Per>" + lblSGSTPer.Text + "</SGST_Per>";
                            Xml_LedgerTx += "<IGST_Per>" + lblIGSTPer.Text + "</IGST_Per>";
                            Xml_LedgerTx += "<CGSTAmt>" + lblCGSTAmt.Text + "</CGSTAmt>";
                            Xml_LedgerTx += "<SGSTAmt>" + lblSGSTAmt.Text + "</SGSTAmt>";
                            Xml_LedgerTx += "<IGSTAmt>" + lblIGSTAmt.Text + "</IGSTAmt>";
                            Xml_LedgerTx += "<GSTApplicable>" + lblGSTApplicable.Text + "</GSTApplicable>";
                            Xml_LedgerTx += "<Taxbility>" + lblTaxbility.Text + "</Taxbility>";

                            Xml_LedgerTx += "</row>";

                        }
                        Xml_LedgerTx += "</Xml_LedgerTx>";
                        if (ledgertxcount == 1)
                        {
                            objdb.ByProcedure("SpFinLedgerTx",
                               new string[] { "flag", "XmlStr" },
                               new string[] { "13", Xml_LedgerTx }, "dataset");
                        }


                        XmlStr = "<XML_LedgerSet>";
                        string XmlBillTxNew = "<XML_BillTxNew>";
                        string XmlBillTxAgn = "<XML_BillTxAgn>";
                        int BillTxNew = 0;
                        int BillTxAgn = 0;
                        int LedgerSet = 0;
                        ...
                        for (int i = 0; i < LedgerTable; i++)
                        {
                            ...
                            if (lbltype.Text == "BillByBill")
                            {
                                ...
                                //new string[] { "0", Ledger_ID.Text, "Main Ledger", VoucherTx_ID, "CreditSale Voucher", LedgerTxAmount, Month.ToString(), Year.ToString()
                                //    , FinancialYear.ToString(), ViewState["Office_ID"].ToString(), LedgerTx_IsActive, ViewState["Emp_ID"].ToString(), (i + 1).ToString(), "BillByBill" }, "dataset");

                                LedgerSet = 1;

                                XmlStr += "<row>";
                                XmlStr += "<Ledger_ID>" + Ledger_ID.Text + "</Ledger_ID>";
                                XmlStr += "<LedgerTx_Type>" + "Main Ledger" + "</LedgerTx_Type>";
                                XmlStr += "<VoucherTx_ID>" + VoucherTx_ID + "</VoucherTx_ID>";
                                XmlStr += "<VoucherTx_Type>" + "CreditSale Voucher" + "</VoucherTx_Type>";
                                XmlStr += "<LedgerTx_Amount>" + LedgerTxAmount + "</LedgerTx_Amount>";
                                XmlStr += "<LedgerTx_Month>" + Month.ToString() + "</LedgerTx_Month>";
                                XmlStr += "<LedgerTx_Year>" + Year.ToString() + "</LedgerTx_Year>";
                                XmlStr += "<LedgerTx_FY>" + FinancialYear.ToString() + "</LedgerTx_FY>";
                                XmlStr += "<Office_ID>" + ViewState["Office_ID"].ToString() + "</Office_ID>";
                                XmlStr += "<LedgerTx_IsActive>" + LedgerTx_IsActive + "</LedgerTx_IsActive>";
                                XmlStr += "<LedgerTx_InsertedBy>" + ViewState["Emp_ID"].ToString() + "</LedgerTx_InsertedBy>";
                                XmlStr += "<LedgerTx_OrderBy>" + (i + 1).ToString() + "</LedgerTx_OrderBy>";
                                XmlStr += "<LedgerTx_MaintainType>" + "BillByBill" + "</LedgerTx_MaintainType>";
                                XmlStr += "</row>";
                                    ...
                                    if (dsBillByBillTemp.Tables[j].TableName == TableId.ToString())
                                    {
                                        for (int k = 0; k < dsBillByBillTemp.Tables[j].Rows.Count; k++)
                                        {
                                            ...
                                            if (BillByBillTx_RefType.ToString() == "New Ref")
                                            {
                                                ...
                                                //new string[] { "flag", "VoucherTx_ID", "Ledger_ID", "BillByBillTx_RefType", "BillByBillTx_Ref", "BillByBillTx_Amount",
                                                //    "BillByBillTx_Date", "Office_ID", "BillByBillTx_FY", "BillByBillTx_IsActive", "BillByBillTx_OrderBy", "BillByBillTx_OrderNo",
                                                //    "SchemeTx_ID", "BillByBillTx_OrderDate", "BillByBillTx_ConsigneeName", "LedgerTx_OrderBy" },
                                                //new string[] { "3", VoucherTx_ID, Ledger_ID.Text, BillByBillTx_RefType, BillByBillTx_Ref, BillByBillTx_Amount
                                                //    , Convert.ToDateTime(txtVoucherTx_Date.Text, cult).ToString("yyyy/MM/dd"), ViewState["Office_ID"].ToString(), 
                                                //    FinancialYear.ToString(), "0", BillByBillTx_OrderBy.ToString(), txtVoucherTx_OrderNo.Text, ddlScheme.SelectedValue.ToString(), 
                                                //    VoucherTx_OrderDate, txtNameofConsignee.Text, (i + 1).ToString() }, "dataset");

                                                BillTxNew = 1;

                                                XmlBillTxNew += "<row>";
                                                XmlBillTxNew += "<VoucherTx_ID>" + VoucherTx_ID + "</VoucherTx_ID>";
                                                XmlBillTxNew += "<Ledger_ID>" + Ledger_ID.Text + "</Ledger_ID>";
                                                XmlBillTxNew += "<BillByBillTx_RefType>" + BillByBillTx_RefType + "</BillByBillTx_RefType>";
                                                XmlBillTxNew += "<BillByBillTx_Ref>" + BillByBillTx_Ref + "</BillByBillTx_Ref>";
                                                XmlBillTxNew += "<BillByBillTx_Amount>" + BillByBillTx_Amount + "</BillByBillTx_Amount>";
                                                XmlBillTxNew += "<BillByBillTx_Date>" + Convert.ToDateTime(txtVoucherTx_Date.Text, cult).ToString("yyyy/MM/dd") + "</BillByBillTx_Date>";
                                                XmlBillTxNew += "<Office_ID>" + ViewState["Office_ID"].ToString() + "</Office_ID>";
                                                XmlBillTxNew += "<BillByBillTx_FY>" + FinancialYear.ToString() + "</BillByBillTx_FY>";
                                                XmlBillTxNew += "<BillByBillTx_IsActive>" + "0" + "</BillByBillTx_IsActive>";
                                                XmlBillTxNew += "<BillByBillTx_OrderBy>" + BillByBillTx_OrderBy.ToString() + "</BillByBillTx_OrderBy>";
                                                XmlBillTxNew += "<BillByBillTx_OrderNo>" + txtVoucherTx_OrderNo.Text + "</BillByBillTx_OrderNo>";
                                                XmlBillTxNew += "<SchemeTx_ID>" + ddlScheme.SelectedValue.ToString() + "</SchemeTx_ID>";
                                                XmlBillTxNew += "<BillByBillTx_OrderDate>" + VoucherTx_OrderDate + "</BillByBillTx_OrderDate>";
                                                XmlBillTxNew += "<BillByBillTx_ConsigneeName>" + txtNameofConsignee.Text + "</BillByBillTx_ConsigneeName>";
                                                XmlBillTxNew += "<LedgerTx_OrderBy>" + (i + 1).ToString() + "</LedgerTx_OrderBy>";
                                                XmlBillTxNew += "</row>";
                                            }
                                            else
                                            {
                                                ...
                                                //    objdb.ByProcedure("SpFinBillByBillTx",
                                                //new string[] { "flag", "VoucherTx_ID", "Ledger_ID", "BillByBillTx_RefType", "BillByBillTx_Ref", "BillByBillTx_Amount",
                                                //    "BillByBillTx_Date", "Office_ID", "BillByBillTx_FY", "BillByBillTx_IsActive", "BillByBillTx_OrderBy", "LedgerTx_OrderBy" },
                                                //new string[] { "3", VoucherTx_ID, Ledger_ID.Text, BillByBillTx_RefType, BillByBillTx_Ref, BillByBillTx_Amount,
                                                //    Convert.ToDateTime(txtVoucherTx_Date.Text, cult).ToString("yyyy/MM/dd"), ViewState["Office_ID"].ToString(),
                                                //    FinancialYear.ToString(), "0", BillByBillTx_OrderBy.ToString(), (i + 1).ToString() }, "dataset");

                                                BillTxAgn = 1;

                                                XmlBillTxAgn += "<row>";
                                                XmlBillTxAgn += "<VoucherTx_ID>" + VoucherTx_ID + "</VoucherTx_ID>";
                                                XmlBillTxAgn += "<Ledger_ID>" + Ledger_ID.Text + "</Ledger_ID>";
                                                XmlBillTxAgn += "<BillByBillTx_RefType>" + BillByBillTx_RefType + "</BillByBillTx_RefType>";
                                                XmlBillTxAgn += "<BillByBillTx_Ref>" + BillByBillTx_Ref + "</BillByBillTx_Ref>";
                                                XmlBillTxAgn += "<BillByBillTx_Amount>" + BillByBillTx_Amount + "</BillByBillTx_Amount>";
                                                XmlBillTxAgn += "<BillByBillTx_Date>" + Convert.ToDateTime(txtVoucherTx_Date.Text, cult).ToString("yyyy/MM/dd") + "</BillByBillTx_Date>";
                                                XmlBillTxAgn += "<Office_ID>" + ViewState["Office_ID"].ToString() + "</Office_ID>";
                                                XmlBillTxAgn += "<BillByBillTx_FY>" + FinancialYear.ToString() + "</BillByBillTx_FY>";
                                                XmlBillTxAgn += "<BillByBillTx_IsActive>" + "0" + "</BillByBillTx_IsActive>";
                                                XmlBillTxAgn += "<BillByBillTx_OrderBy>" + BillByBillTx_OrderBy.ToString() + "</BillByBillTx_OrderBy>";
                                                XmlBillTxAgn += "<LedgerTx_OrderBy>" + (i + 1).ToString() + "</LedgerTx_OrderBy>";
                        ...
                        XmlStr += "</XML_LedgerSet>";
                        XmlBillTxNew += "</XML_BillTxNew>";
                        XmlBillTxAgn += "</XML_BillTxAgn>";
                        if (LedgerSet == 1)
                        {
                            objdb.ByProcedure("SpFinLedgerTx",
                               new string[] { "flag", "XmlStr", "XmlBillTxNew", "BillTxNew", "XmlBillTxAgn", "BillTxAgn" },
                               new string[] { "14", XmlStr, XmlBillTxNew, BillTxNew.ToString(), XmlBillTxAgn, BillTxAgn.ToString() }, "dataset");
                        }
                ...
                else if (btnAccept.Text == "Update" && ViewState["VoucherTx_ID"].ToString() != "0" && Status == 0)
                {
                    ...
                    for (rowItemIndex = 0; rowItemIndex < gridItemRows; rowItemIndex++)
                    {
                        ...
                        Label lblLedgerID = (Label)GridViewItem.Rows[rowItemIndex].Cells[0].FindControl("lblLedgerID");
                        Label lblTaxbility = (Label)GridViewItem.Rows[rowItemIndex].Cells[0].FindControl("lblTaxbility");
                        //objdb.ByProcedure("SpFinItemTx", new string[] { "flag", "VoucherTx_ID", "VoucherTx_Name", "VoucherTx_Type", "Ledger_ID", "Item_id", "Unit_id", 
                        //    "Quantity", "Rate", "Amount", "HSN_Code", "IGST_Per", "CGST_Per", "SGST_Per", "CGSTAmt", "SGSTAmt", "IGSTAmt", "Warehouse_id", "Office_ID",
                        //    "ItemTx_FY", "ItemTx_IsActive", "ItemTx_InsertedBy", "ItemTx_OrderBy", "Taxbility" },
                        //    new string[] { "0", ViewState["VoucherTx_ID"].ToString(),     "Sales Voucher", "CreditSale Voucher", lblLedgerID.Text, lblItemID.Text, 
                        //        lblUnit_id.Text, lblQuantity.Text, lblRate.Text, lblAmount.Text,  lblHSNCode.Text, lblIGSTPer.Text, lblCGSTPer.Text, lblSGSTPer.Text,
                        //        lblCGST.Text, lblSGST.Text, lblIGST.Text, ddlWarehouse.SelectedValue.ToString(), ViewState["Office_ID"].ToString(), FinancialYear.ToString(),
                        //        ItemTx_IsActive, ViewState["Emp_ID"].ToString(), lblItemRowNo.Text, lblTaxbility.Text }, "dataset");

                        ledgercount = 1;

                        XmlItemTx += "<row>";
                        XmlItemTx += "<VoucherTx_ID>" + ViewState["VoucherTx_ID"].ToString() + "</VoucherTx_ID>";
                        XmlItemTx += "<VoucherTx_Name>" + "Sales Voucher" + "</VoucherTx_Name>";
                        XmlItemTx += "<VoucherTx_Type>" + "CreditSale Voucher" + "</VoucherTx_Type>";
                        XmlItemTx += "<Ledger_ID>" + lblLedgerID.Text + "</Ledger_ID>";
                        XmlItemTx += "<Item_id>" + lblItemID.Text + "</Item_id>";
                        ...
                        if (ds != null && ds.Tables[0].Rows.Count > 0)
                        {
                            if (ds.Tables[0].Rows[0]["InventoryAffected"].ToString() == "Yes")
                            {
                                ...
                                XmlInventoryAffected += "<Dr>" + lblQuantity.Text + "</Dr>";
                                XmlInventoryAffected += "<Rate>" + lblRate.Text + "</Rate>";
                                XmlInventoryAffected += "<TransactionID>" + ViewState["VoucherTx_ID"].ToString() + "</TransactionID>";
                                XmlInventoryAffected += "<TransactionFrom>" + "CreditSale Voucher" + "</TransactionFrom>";
                                XmlInventoryAffected += "<InvoiceNo>" + VoucherTx_No + "</InvoiceNo>";
                                XmlInventoryAffected += "<Office_Id>" + ViewState["Office_ID"].ToString() + "</Office_Id>";
                                XmlInventoryAffected += "<Warehouse_id>" + lblWarehouse_id.Text + "</Warehouse_id>";
                        ...
                        //objdb.ByProcedure("SpFinLedgerTx",
                        //        new string[] { "flag", "Ledger_ID", "LedgerTx_Type", "VoucherTx_ID", "Item_id", "VoucherTx_Type", "LedgerTx_Amount", "LedgerTx_Month"
                        //            , "LedgerTx_Year", "LedgerTx_FY", "Office_ID", "LedgerTx_IsActive", "LedgerTx_InsertedBy", "LedgerTx_OrderBy" },
                        //        new string[] { "0", lblLedgerID.Text, "Item Ledger", ViewState["VoucherTx_ID"].ToString(), lblItemID.Text, "CreditSale Voucher", lblAmount.Text
                        //            , Month.ToString(), Year.ToString(), FinancialYear.ToString(), ViewState["Office_ID"].ToString(), LedgerTx_IsActive, ViewState["Emp_ID"].ToString(), lblItemRowNo.Text }, "dataset");

                        XmlStr += "<row>";
                        XmlStr += "<Ledger_ID>" + lblLedgerID.Text + "</Ledger_ID>";
                        XmlStr += "<LedgerTx_Type>" + "Item Ledger" + "</LedgerTx_Type>";
                        XmlStr += "<VoucherTx_ID>" + ViewState["VoucherTx_ID"].ToString() + "</VoucherTx_ID>";
                        XmlStr += "<Item_id>" + lblItemID.Text + "</Item_id>";
                        XmlStr += "<VoucherTx_Type>" + "CreditSale Voucher" + "</VoucherTx_Type>";
                        XmlStr += "<LedgerTx_Amount>" + lblAmount.Text + "</LedgerTx_Amount>";
                        XmlStr += "<LedgerTx_Month>" + Month.ToString() + "</LedgerTx_Month>";
                    ...
                    for (int rowIndex = 0; rowIndex < gridRows; rowIndex++)
                    {
                        ...
                        //objdb.ByProcedure("SpFinLedgerTx",
                        //new string[] { "flag", "Ledger_ID", "LedgerTx_Type", "VoucherTx_ID", "VoucherTx_Type", "LedgerTx_Amount", "LedgerTx_Month", "LedgerTx_Year"
                        //    , "LedgerTx_FY", "Office_ID", "LedgerTx_IsActive", "LedgerTx_InsertedBy", "LedgerTx_OrderBy", "HSN_Code", "CGST_Per", "SGST_Per", "IGST_Per", 
                        //    "CGSTAmt", "SGSTAmt", "IGSTAmt", "GSTApplicable", "Taxbility" },
                        //new string[] { "0", lblID.Text, "Sub Ledger", ViewState["VoucherTx_ID"].ToString(), "CreditSale Voucher", txtAmount.Text, Month.ToString(), 
                        //    Year.ToString(), FinancialYear.ToString(), ViewState["Office_ID"].ToString(), LedgerTx_IsActive, ViewState["Emp_ID"].ToString()
                        //    , (rowIndex + 2).ToString(), lblHSNCode.Text, lblCGSTPer.Text, lblSGSTPer.Text, lblIGSTPer.Text, lblCGSTAmt.Text, lblSGSTAmt.Text, lblIGSTAmt.Text,
                        //    lblGSTApplicable.Text, lblTaxbility.Text }, "dataset");
                        ...
                        Xml_LedgerTx += "<Ledger_ID>" + lblID.Text + "</Ledger_ID>";
                        Xml_LedgerTx += "<LedgerTx_Type>" + "Sub Ledger" + "</LedgerTx_Type>";
                        Xml_LedgerTx += "<VoucherTx_ID>" + ViewState["VoucherTx_ID"].ToString() + "</VoucherTx_ID>";
                        Xml_LedgerTx += "<VoucherTx_Type>" + "CreditSale Voucher" + "</VoucherTx_Type>";
                        Xml_LedgerTx += "<LedgerTx_Amount>" + txtAmount.Text + "</LedgerTx_Amount>";
                        Xml_LedgerTx += "<LedgerTx_Month>" + Month.ToString() + "</LedgerTx_Month>";
                        Xml_LedgerTx += "<LedgerTx_Year>" + Year.ToString() + "</LedgerTx_Year>";
    ...
    {
        mis_Finance_VoucherSaleCredit OBJ = new mis_Finance_VoucherSaleCredit();
