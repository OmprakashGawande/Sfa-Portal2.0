            ...
            <div class="box box-success">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <%--LEDGER DETAIL MONTH WISE--%>
                            <asp:GridView ID="GridView4" DataKeyNames="ItmStock_id" runat="server" AutoGenerateColumns="false" class="table table-hover table-bordered" ShowHeaderWhenEmpty="true" OnRowDeleting="GridView4_RowDeleting" EmptyDataText="No Record Found..!">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Narration & Refrence No">
                                        <ItemTemplate>
                                            <asp:Label ID="lblVoucherRemark" Text='<%# Eval("Remark").ToString() %>' runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Inward Quantity">
                                        <ItemTemplate>
                                            <asp:Label ID="lblVoucherInward" Text='<%# Eval("Inward").ToString() %>' runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Outward Quantity">
                                        <ItemTemplate>
                                            <asp:Label ID="lblVoucherOutward" Text='<%# Eval("Outward").ToString() %>' runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Rate">
                                        <ItemTemplate>
                                            <asp:Label ID="lblVoucherRate" Text='<%# Eval("Rate").ToString() %>' runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Amount">
                                        <ItemTemplate>
                                            <asp:Label ID="lblVoucherAmount" Text='<%# Eval("Amount").ToString() %>' runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
