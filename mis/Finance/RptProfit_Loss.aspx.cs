...
public partial class mis_Finance_RptProfit_Loss : System.Web.UI.Page
{
    ...
    protected void FillDropdown()
    {
        try
        {
            ...
            //    ddlOffice.Enabled = true;
            //}
            //ds = objdb.ByProcedure("SpFinRptProfitLoss",
            //       new string[] { "flag" },
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        if (Office != "")
        {
            ...
            string headingFirst = "<p class='text-center' style='font-weight:600'>Profit & Loss <br /> SFA Technologies Pvt. Ltd. <br/> [ " + OfficeName + " ] <br />  " + Convert.ToDateTime(txtFromDate.Text, cult).ToString("dd-MM-yyyy") + "  To " + Convert.ToDateTime(txtToDate.Text, cult).ToString("dd-MM-yyyy") + "</p>";
    ...
    protected void btngraphical_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Office != "")
            {
                ...
                headingPL = "<p class='text-center' style='font-weight:600'>Profit & Loss<br /> SFA Technologies Pvt. Ltd. <br/> [ " + OfficeName + " ] <br />  " + Convert.ToDateTime(txtFromDate.Text, cult).ToString("dd-MM-yyyy") + "  To " + Convert.ToDateTime(txtToDate.Text, cult).ToString("dd-MM-yyyy") + "</p>";
