...
public partial class mis_Finance_HOLoanReconciliationReport : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (msg == "")
            {
                ...
                {
                    string headingFirst = "<p class='text-center' style='font-weight:600; font-size:16px;'>HO Loan Reconciliation<br /> MP State Agro Industries Development Corporation, <br/> [ " + ddlOffice.SelectedItem.Text + " ] <br />  " + Convert.ToDateTime(txtFromDate.Text, cult).ToString("dd-MM-yyyy") + "  To " + Convert.ToDateTime(txtToDate.Text, cult).ToString("dd-MM-yyyy") + "<br/>Ledger Name : " + ddlLedger.SelectedItem.ToString() + "</p>";
