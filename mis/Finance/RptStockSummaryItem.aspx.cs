...
public partial class mis_Finance_RptStockSummaryItem : System.Web.UI.Page
{
    ...
    private void fill_details()
    {
        try
        {
            ...
            //string headingFirst = "<p class='text-center' style='font-weight:600'>Group Wise Stock Summary <br /> MP State Agro Industries Development Corporation, <br/> [Offices:  " + OfficeName + " ] <br/>-------<br/> [Groups: " + itemgroupname + " ] <br />  " + Convert.ToDateTime(txtFromDate.Text, cult).ToString("dd-MM-yyyy") + "  To " + Convert.ToDateTime(txtToDate.Text, cult).ToString("dd-MM-yyyy") + "</p>";

            string headingFirst = "<p class='text-center' style='font-weight:600'>Group Wise Stock Summary <br /> MP State Agro Industries Development Corporation, <br/> [Offices:  " + OfficeName + " ] <br/>-------<br/> " + Convert.ToDateTime(txtFromDate.Text, cult).ToString("dd-MM-yyyy") + "  To " + Convert.ToDateTime(txtToDate.Text, cult).ToString("dd-MM-yyyy") + "</p>";

            lblheadingmain.Text = headingFirst;

            lblprinttext.ToolTip = "<p class='text-center' style='font-size:18px'>Group Wise Stock Summary <br /> MP State Agro Industries Development Corporation, <br/> [Offices:  " + OfficeName + " ] <br/>[Groups: " + itemgroupname + " ] <br />  " + Convert.ToDateTime(txtFromDate.Text, cult).ToString("dd-MM-yyyy") + "  To " + Convert.ToDateTime(txtToDate.Text, cult).ToString("dd-MM-yyyy") + "</p>";
    ...
    protected void FillGridNextLedger(int item_id, string item_name)
    {
        try
        {
            ...
            lblprinttext.ToolTip = "<p class='text-center' style='font-size:18px'>" + item_name + "<br /> MP State Agro Industries Development Corporation, <br/> [Offices:  " + OfficeName + " ] <br />  " + Convert.ToDateTime(txtFromDate.Text, cult).ToString("dd-MM-yyyy") + "  To " + Convert.ToDateTime(txtToDate.Text, cult).ToString("dd-MM-yyyy") + "</p>";
    ...
    protected void FillGridNextLedger3(int item_id, string item_name, string DisplayType)
    {
        ...
        try
        {
            ...
            lblprinttext.ToolTip = "<p class='text-center' style='font-size:18px'>" + item_name + "<br /> MP State Agro Industries Development Corporation, <br/> [Offices:  " + OfficeName + " ] <br />  " + Convert.ToDateTime(txtFromDate.Text, cult).ToString("dd-MM-yyyy") + "  To " + Convert.ToDateTime(txtToDate.Text, cult).ToString("dd-MM-yyyy") + " && "
                     + Convert.ToDateTime(ViewState["FromDateNew"], cult).ToString("dd-MM-yyyy") + "  To " + Convert.ToDateTime(ViewState["ToDateNew"], cult).ToString("dd-MM-yyyy") + " </p>";
    ...
    private void fill_details1(int itemgroup, string item_name)
    {
        try
        {
            ...
            string headingFirst = "<p class='text-center' style='font-weight:600'>Stock Summary (" + item_name + ")<br /> MP State Agro Industries Development Corporation, <br/> [ " + OfficeName + " ] <br />  " + Convert.ToDateTime(txtFromDate.Text, cult).ToString("dd-MM-yyyy") + "  To " + Convert.ToDateTime(txtToDate.Text, cult).ToString("dd-MM-yyyy") + "</p>";
            lblheadingFirst.Text = headingFirst;

            lblprinttext.ToolTip = "<p class='text-center' style='font-size:18px'>Stock Summary (" + item_name + ")<br /> MP State Agro Industries Development Corporation, <br/> [Offices:  " + OfficeName + " ] <br />  " + Convert.ToDateTime(txtFromDate.Text, cult).ToString("dd-MM-yyyy") + "  To " + Convert.ToDateTime(txtToDate.Text, cult).ToString("dd-MM-yyyy") + "</p>";
