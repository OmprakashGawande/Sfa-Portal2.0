...
public partial class mis_Finance_RptGSTR_1Jul : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void FillDropdown()
    {
        try
        {
            ...
            ds = objdb.ByProcedure("SpFinRptGSTR_1Jul",
                   new string[] { "flag" },
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (txtFromDate.Text != "" && txtToDate.Text != "" && Office != "")
            {
                ...
                ds = objdb.ByProcedure("SpFinRptGSTR_1Jul", new string[] { "flag", "Office_ID_Mlt", "FromDate", "ToDate" }, new string[] { "1", Office, Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd") }, "dataset");
                if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
                {
                    // START TOP SECTION
                    DivTable.Visible = true;
                    ...
                    //DataSet ds1 = objdb.ByProcedure("SpFinRptGSTR_1Jul", new string[] { "flag", "MltVoucherTx_ID", "MltVoucherTx_IDNotin" }, new string[] { "9", ViewState["MltIncludedRet"].ToString(), "" }, "dataset");
                    DataSet ds1 = objdb.ByProcedure("SpFinRptGSTR_1Jul", new string[] { "flag", "MltVoucherTx_ID", "MltVoucherTx_IDNotin" }, new string[] { "9", ViewState["MltVoucher"].ToString(), "" }, "dataset");
    ...
    protected void btnEB2BVoucher_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            //{
            ds = objdb.ByProcedure("SpFinRptGSTR_1Jul", new string[] { "flag", "Office_ID_Mlt", "MltVoucherTx_ID", "MltVoucherTx_IDNotin" }, new string[] { "3", Office, ViewState["MltB2BVoucher"].ToString(), "" }, "dataset");
            if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
            {
    ...
    protected void btnEB2CLVoucher_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            //if (ddlOffice.SelectedIndex > 0)
            //{
            ds = objdb.ByProcedure("SpFinRptGSTR_1Jul", new string[] { "flag", "Office_ID_Mlt", "MltVoucherTx_ID", "MltVoucherTx_IDNotin" }, new string[] { "4", Office, ViewState["MltB2CLVoucher"].ToString(), "" }, "dataset");
            if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
            {
                int rowcount = ds.Tables[0].Rows.Count;
    ...
    protected void btnEB2CMVoucher_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            //if (ddlOffice.SelectedIndex > 0)
            //{
            ds = objdb.ByProcedure("SpFinRptGSTR_1Jul", new string[] { "flag", "MltVoucherTx_ID", "MltVoucherTx_IDNotin" }, new string[] { "12", ViewState["MltB2CMVoucher"].ToString(), "" }, "dataset");
            if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
            {
                int rowcount = ds.Tables[0].Rows.Count;
    ...
    protected void btnEHSN_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            decimal CentralTaxAmount = 0;
            decimal StateUTTaxAmount = 0;
            //ds = objdb.ByProcedure("SpFinRptGSTR_1Jul", new string[] { "flag", "MltVoucherTx_ID", "MltVoucherTx_IDNotin" }, new string[] { "13", ViewState["MltIncludedRet"].ToString(), "" }, "dataset");
            ds = objdb.ByProcedure("SpFinRptGSTR_1Jul", new string[] { "flag", "MltVoucherTx_ID", "MltVoucherTx_IDNotin" },
    ...
    protected void FILLGRID(string MltVoucherTx_ID, string MltVoucherTx_IDNotin)
    {
        try
        {
            ...
            {
                lblDateRange.Text = txtFromDate.Text + " to " + txtToDate.Text;
                //ds = objdb.ByProcedure("SpFinRptGSTR_1Jul", new string[] { "flag", "Office_ID", "FromDate", "ToDate" }, new string[] { FflagNo, ddlOffice.SelectedValue.ToString(), Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd") }, "dataset");
                ds = objdb.ByProcedure("SpFinRptGSTR_1Jul", new string[] { "flag", "MltVoucherTx_ID", "MltVoucherTx_IDNotin" }, new string[] { "2", MltVoucherTx_ID, MltVoucherTx_IDNotin }, "dataset");
                if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
                {
    ...
    protected void FILLRateWiseVoucher(string MltVoucherTx_ID, string MltVoucherTx_IDNotin)
    {
        try
        {
            ...
            {
                //lblDateRange.Text = txtFromDate.Text + " to " + txtToDate.Text;
                ds = objdb.ByProcedure("SpFinRptGSTR_1Jul", new string[] { "flag", "MltVoucherTx_ID", "MltVoucherTx_IDNotin" }, new string[] { "6", MltVoucherTx_ID, MltVoucherTx_IDNotin }, "dataset");
                if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
                {
                    btnBack.Visible = false;
                    DivTable.Visible = false;
    ...
    protected void FILLDayBook(string MltVoucherTx_ID, string MltVoucherTx_IDNotin, string GSTRate)
    {
        try
        {
            ...
            {
                // lblDateRange.Text = txtFromDate.Text + " to " + txtToDate.Text;
                ds = objdb.ByProcedure("SpFinRptGSTR_1Jul", new string[] { "flag", "MltVoucherTx_ID", "MltVoucherTx_IDNotin", "GSTRate" }, new string[] { "8", MltVoucherTx_ID, MltVoucherTx_IDNotin, GSTRate }, "dataset");
                if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
                {
                    btnBack.Visible = false;
                    DivTable.Visible = false;
    ...
    protected void btnHSNSummary_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (txtFromDate.Text != "" && txtToDate.Text != "")
            {
                //ds = objdb.ByProcedure("SpFinRptGSTR_1Jul", new string[] { "flag", "MltVoucherTx_ID", "MltVoucherTx_IDNotin" }, new string[] { "9", ViewState["MltIncludedRet"].ToString(), "" }, "dataset");
                ds = objdb.ByProcedure("SpFinRptGSTR_1Jul", new string[] { "flag", "MltVoucherTx_ID", "MltVoucherTx_IDNotin" }, new string[] { "9", ViewState["MltVoucher"].ToString(), "" }, "dataset");
                if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
                {
    ...
    protected void GridHSNSummery_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            ...
            if (e.CommandName == "View")
            {
                ...
                ds = objdb.ByProcedure("SpFinRptGSTR_1Jul", new string[] { "flag", "MltVoucherTx_ID", "MltVoucherTx_IDNotin", "HSN", "Description", "TypeOfSupply", "UQC" }, new string[] { "10", ViewState["MltIncludedRet"].ToString(), "", lblHSN.Text, lblDescription.Text, lblTypeOfSupply.Text, lblUQC.Text }, "dataset");
                if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
                {
                    btnBack.Visible = false;
                    DivTable.Visible = false;
    ...
    protected void btnShowDetailBook_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (ViewState["DaybookDetail"].ToString() == "True")
            {
                if (txtFromDate.Text != "" && txtToDate.Text != "")
                {
                    ds = objdb.ByProcedure("SpFinRptGSTR_1Jul", new string[] { "flag", "MltVoucherTx_ID", "MltVoucherTx_IDNotin" }, new string[] { "11", ViewState["MltVoucherTx_DayBook"].ToString(), ViewState["MltVoucherTx_DayBookNotin"].ToString() }, "dataset");
                    if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
                    {
    ...
    protected void btnAllExcel_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string IntraReg = "";
            string IntraUnReg = "";
            ds = objdb.ByProcedure("SpFinRptGSTR_1Jul", new string[] { "flag", "MltVoucherTx_ID" }, new string[] { "14", ViewState["MltNilRatedVoucher"].ToString() }, "dataset");
            if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
            {
