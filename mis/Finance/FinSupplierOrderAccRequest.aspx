<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="FinSupplierOrderAccRequest.aspx.cs" Inherits="mis_Finance_FinSupplierOrderAccRequest" %>
                ...
                <div class="col-md-12">
                    <div class="box box-success">
                        <div class="box-header">
                            <h3 class="box-title">Account Supplier Order Requests  (By Bill Date)</h3>
                        </div>
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <h4 class="box-title">Account Supplier Order Requests By Bill Date</h4>
                                        ...
                                        <asp:GridView ID="GridView1" runat="server" class="table table-hover table-bordered" ShowHeaderWhenEmpty="true" DataKeyNames="OrderID" AutoGenerateColumns="False" EmptyDataText="No records Found" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Status">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblStatus" Text='<%# Eval("AccountStatus").ToString()%>' runat="server" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
