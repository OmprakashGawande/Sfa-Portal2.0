<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="VoucherSaleCredit_Old.aspx.cs" Inherits="mis_Finance_VoucherSaleCredit_Old" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="Server">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-success" style="background-color: #e3dcc0">
                        ...
                        <div class="box-body">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6" style="margin-left: -32px;">
                                                <asp:TextBox runat="server" CssClass="form-control" ID="txtVoucherTx_No" placeholder="Enter Voucher/Bill No." ClientIDMode="Static" MaxLength="13" autocomplete="off" onkeypress="return abc(event);"></asp:TextBox>
						 ...
						 <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <asp:TextBox ID="txtItemDescription" ClientIDMode="Static" runat="server" CssClass="form-control">
                                                        </asp:TextBox>
                                        ...
                                        <!-- ItemDetail GridView-->
                                        <asp:GridView ID="GridViewItem" runat="server" DataKeyNames="ID,ItemID" ClientIDMode="Static" class="table table-bordered customCSS" Style="margin-bottom: 0px;" AutoGenerateColumns="False" ShowHeaderWhenEmpty="true" OnSelectedIndexChanged="GridViewItem_SelectedIndexChanged" OnRowDeleting="GridViewItem_RowDeleting" ShowFooter="true">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Item Name" ItemStyle-Width="15%">
                                                    <ItemTemplate>

                                                        <asp:Label ID="lblItem" runat="server"  Text='<%# string.Concat(Eval("Item"), " - ", Eval("ItemDescription"))%>'></asp:Label>
                                                        <asp:Label ID="lblItemDescription" CssClass="hidden" runat="server" Text='<%# Eval("ItemDescription").ToString()%>'></asp:Label>
                                                ...
                                                <asp:TemplateField HeaderText="Action">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="Select" runat="server" CssClass="label label-default" CausesValidation="False" CommandName="Select" Text="View"></asp:LinkButton>
                                                        &nbsp;
                            ...
                            <asp:Panel ID="panel2" runat="server">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>Advance/Cr Note</label>
                                            <asp:DropDownList ID="ddlAdvanceCr" runat="server" ClientIDMode="Static" CssClass="form-control">
                                                <asp:ListItem Value="None" Text="None"></asp:ListItem>
                                                <asp:ListItem Value="Advance" Text="Advance"></asp:ListItem>
                                                <asp:ListItem Value="Cr Note" Text="Cr Note"></asp:ListItem>
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <label>Advance/Cr Note Detail</label>
                                            <div class="">
                                                <asp:TextBox runat="server" CssClass="form-control" ID="txtVoucherTx_MRDetails" autocomplete="off"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>Advance/Cr Amount</label>
                                            <asp:TextBox runat="server" ID="txtVoucherTx_AdvanceAmt" CssClass="form-control" Text="0.00" onkeypress="return validateDec(this,event)" ClientIDMode="Static" autocomplete="off"></asp:TextBox>
                                            <small><span id="valtxtVoucherTx_AdvanceAmt" style="color: red;"></span></small>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox runat="server" ID="txtVoucherTx_Farmer" CssClass="form-control" ClientIDMode="Static" autocomplete="off"></asp:TextBox>
                                            <small><span id="valtxtVoucherTx_Farmer" style="color: red;"></span></small>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Block</label>
                                            <asp:TextBox runat="server" ID="txtVoucherTx_Sado" CssClass="form-control" ClientIDMode="Static" autocomplete="off"></asp:TextBox>
                                            <small><span id="valtxtVoucherTx_Sado" style="color: red;"></span></small>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Gram</label>
                                            <asp:TextBox runat="server" ID="txtVoucherTx_Gram" CssClass="form-control" ClientIDMode="Static" autocomplete="off"></asp:TextBox>
                                            <small><span id="valtxtVoucherTx_Gram" style="color: red;"></span></small>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>Category</label>
                                            <asp:DropDownList ID="ddlCategory" runat="server" ClientIDMode="Static" CssClass="form-control">
						...
						<asp:ListItem Value="Small,Marginal,Woman Farmers" Text="Small,Marginal,Woman Farmers"></asp:ListItem>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Farmer Other Detail</label>
                                            <asp:TextBox runat="server" ID="txtFarmerOtherDetail" TextMode="MultiLine" CssClass="form-control" ClientIDMode="Static"></asp:TextBox>
                                        </div>
                                    </div>
            ...
            <div class="modal fade" id="ModalSubItemDetail" role="dialog">
                <div class="modal-dialog modal-lg">
                    <!-- Modal content-->
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title">Update Sub Item Details</h4>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                <div class="Heading_SubItemModal">
                                    <div class="col-md-6">
                                        <b>Item: </b>
                                        <asp:Label ID="lblSubItem_item" runat="server" Text=""></asp:Label>
                                    </div>
                                    <div class="col-md-2">
                                        <b>Rate: </b>
                                        <asp:Label ID="lblSubItem_rate" runat="server" Text=""></asp:Label>
                                    </div>
                                    <div class="col-md-2">
                                        <b>Quantity: </b>
                                        <asp:Label ID="lblSubItem_quantity" runat="server" Text=""></asp:Label>
                                    </div>
                                    <div class="col-md-2">
                                        <b>Amount: </b>
                                        <asp:Label ID="lblSubItem_amount" runat="server" Text="" ClientIDMode="Static"></asp:Label>
                                    </div>
                                    <br />
                                    <br />
                                </div>
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <asp:GridView runat="server" CssClass="table table-bordered GVFinItemIngredientTx" ShowHeaderWhenEmpty="true" ID="GVFinItemIngredientTx" AutoGenerateColumns="false" ClientIDMode="Static">
                                            <Columns>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Sub Item">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblIngredient_Name" runat="server" Text='<%# Eval("Ingredient_Name") %>' ToolTip='<%# Eval("Ingredient_Id")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Size/Other Details">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtIngredient_Size" runat="server" MaxLength="90" CssClass="form-control"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Quantity">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtSubItem_Quantity" runat="server" Text='<%# Eval("Ingredient_Size") %>' CssClass="form-control txtQuantity" placeholder="" onblur="return CalculateAmtSubItemTotal()"></asp:TextBox>
                                                        <asp:Label ID="lblSubItem_Unit" Text='<%# Eval("Ingredient_Unit") %>' runat="server" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Rate">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtSubItem_Rate" runat="server" Text='0' CssClass="form-control" onblur="return CalculateAmtSubItemTotal()"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Amount">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtSubItem_Amount" runat="server" Text='0' CssClass="form-control" onblur="return CalculateSubItemGrandTotal()"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
                                        <div class="col-md-12" style="text-align: right; font-weight: 700;">
                                            <asp:HiddenField ID="HF_SubItemTotal" runat="server" ClientIDMode="Static" />
                                            Total :  
                                            <asp:Label ID="lblSubItemTotal" runat="server" Text="" ClientIDMode="Static"></asp:Label>
                                            <br />
                                            Difference  :   
                                            <asp:Label ID="lblsubItemDifference" runat="server" Text="" ClientIDMode="Static"></asp:Label>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <asp:Button ID="btnAddSubItem" runat="server" CssClass="btn btn-flat btn-info" Text="Save Item" OnClick="btnAddSubItem_Click" OnClientClick="return validateSubitemItem();" />
            ...
            <div class="modal fade" id="ModalViewSubItemDetail" role="dialog">
                <div class="modal-dialog modal-lg">
                    <!-- Modal content-->
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <asp:GridView runat="server" CssClass="table table-bordered" ShowHeaderWhenEmpty="true" ID="GVFinViewItemIngredientTx" AutoGenerateColumns="false" ClientIDMode="Static">
                                            <Columns>
                                                <asp:TemplateField HeaderText="SNo." ItemStyle-Width="5%">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblRowNumber" Text='<%# Container.DataItemIndex + 1 %>' runat="server" />
                                                ...
                                                <asp:TemplateField HeaderText="Sub Item">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblIngredient_Name" runat="server" Text='<%# Eval("Ingredient_Name") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Size">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblIngredient_Size" runat="server" Text='<%# Eval("Ingredient_Size") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Quantity">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblIngredient_Quantity" runat="server" Text='<%# Eval("Quantity") %>'></asp:Label>
                                                        <asp:Label ID="lblSubItem_Unit" Text='<%# Eval("Unit") %>' runat="server" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Rate">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblIngredient_Rate" runat="server" Text='<%# Eval("Rate") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Amount">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblIngredient_Amount" runat="server" Text='<%# Eval("Amount") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentFooter" runat="Server">
    ...
    <script>
        ...
        function ModalSubItemDetail(varv) {
            if (varv == "1") {
                alert("Item value and sub item total value should match.");
                $('#ModalSubItemDetail').modal({ backdrop: 'static', keyboard: false }, 'show');
            }
            else {
                $('#ModalSubItemDetail').modal({ backdrop: 'static', keyboard: false }, 'show');
            }
        }
        function ModalViewSubItemDetail() {
            $('#ModalViewSubItemDetail').modal({ backdrop: 'static', keyboard: false }, 'show');
        }
        ...
        function CalculateSubItemGrandTotal() {
            ...
            //var HiddenValue = '<%=hfvalue.Value%>';
            var rowcount = $('#GVFinItemIngredientTx tr').length;

            var inputList = document.querySelectorAll('#GVFinItemIngredientTx tbody input[type="checkbox"]:not(:disabled)');


            $('#GVFinItemIngredientTx tr').each(function (index) {
                if (i > 0) {
                    if (inputList[i].checked == true) {
                        ...
                        $(this).children("td").eq(6).find('input[type="text"]').val(0);
                    }
            ...
            // alert(Tval);
            // debugger;
            var IVal = document.getElementById('<%=lblSubItem_amount.ClientID%>').innerText.trim();
            document.getElementById('<%=lblSubItemTotal.ClientID%>').innerText = Tval;
            $("#HF_SubItemTotal").val(Tval);
            document.getElementById('<%=lblsubItemDifference.ClientID%>').innerText = parseFloat(parseFloat(IVal) - parseFloat(Tval)).toFixed(2);
        ...
        function CalculateAmtSubItemTotal() {
            ...
            $('#GVFinItemIngredientTx tr').each(function (index) {
                if (i > 0) {
                    ...
                    var TvalQ = 0;
                    var TvalR = 0;
                    var TvalQ = $(this).children("td").eq(4).find('input[type="text"]').val();
                    if (TvalQ == "")
                        TvalQ = 0;

                    var TvalR = $(this).children("td").eq(5).find('input[type="text"]').val();
                    if (TvalR == "")
                        TvalR = 0;

                    Tval = parseFloat(parseFloat(TvalQ) * parseFloat(TvalR)).toFixed(2)

                    $(this).children("td").eq(6).find('input[type="text"]').val(Tval);
            ...
            // validateSubitemItem();
            CalculateSubItemGrandTotal();

            return false;
        }

        function validateSubitemItem() {

            var msg = "";
            var IVal = document.getElementById('<%=lblSubItem_amount.ClientID%>').value.trim();
            if (IVal == "")
                IVal = 0;
            var ISubVal = document.getElementById('<%=lblSubItemTotal.ClientID%>').value.trim();
            if (ISubVal == "")
                ISubVal = 0;


            if (parseFloat(IVal).toFixed() != parseFloat(ISubVal).toFixed()) {
                alert("Item value and sub item total value should match.");
                return false;
            }
            else {
