<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="HOLoanReconciliation.aspx.cs" Inherits="mis_Finance_HOLoanReconciliation" %>
        ...
        <section class="content">
            <div class="box box-success">
                <div class="box-header Hiderow">
                    <h3 class="box-title">HO Loan Reconciliation</h3>
                ...
                <div class="box-body">
                    <div class="row Hiderow">
                        ...
                        <%--<div class="col-md-3">
                            <div class="form-group">
                                <label>HO Status<span style="color: red;">*</span></label>
                                <asp:DropDownList ID="ddlHOStatus" runat="server" CssClass="form-control">
                        ...
                        <div class="col-md-12">
                            ...
                            <asp:GridView ID="GridView1" runat="server" ClientIDMode="Static" AutoGenerateColumns="false" class="tab1 table table-hover table-bordered" style="margin-bottom: 0px;"  EmptyDataText="No Record Found.">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="HO Date">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtHOTxn_Date" CssClass="DateAdd" Style="width: 75px; height: 25px;" AutoComplete="off" Text='<%# Eval("HOTxn_Date").ToString() %>' runat="server"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                ...
                                <div class="form-group">
                                    <table class="table table-bordered">
                                        <tr>
                                         ...
                                         <tr>
                                            <th>Amounts not reflected in HO Loan</th>
                                            <th class="alignR">
                                                <asp:Label ID="lblNotRefHODr" runat="server" Text=""></asp:Label>
                                            </th>
                                            <th class="alignR">
                                                <asp:Label ID="lblNotRefHOCr" runat="server" Text=""></asp:Label>
                                            </th>
                                        </tr>
                                         <tr>
                                            <th>As Per HO Loan Balance</th>
                                           <th class="alignR">
                                                <asp:Label ID="lblHOBalanceDr" runat="server" Text=""></asp:Label>
                                            </th>
                                            <th class="alignR">
                                                <asp:Label ID="lblHOBalanceCr" runat="server" Text=""></asp:Label>
                                            </th>
                                        </tr>
                                      
                                    </table>
                                    <div style="float:right;">
                                    <a href="HOReconciliation.aspx" style="width:100px;" class="btn btn-default">Cancel</a>
