...
public partial class mis_Finance_RptGSTR_1 : System.Web.UI.Page
{
    ...
    protected void FILLGRID(string MltVoucherTx_ID, string MltVoucherTx_IDNotin)
    {
        try
        {
            ...
            if (txtFromDate.Text != "" && txtToDate.Text != "")
            {
                ...
                ds = objdb.ByProcedure("SpFinRptGSTR_1", new string[] { "flag", "MltVoucherTx_ID", "MltVoucherTx_IDNotin", "FinancialYear", "Office_ID" },
    ...
    protected void FILLRateWiseVoucher(string MltVoucherTx_ID, string MltVoucherTx_IDNotin, string B2BType)
    {
        try
        {
            ...
            {
                //lblDateRange.Text = txtFromDate.Text + " to " + txtToDate.Text;
                ds = objdb.ByProcedure("SpFinRptGSTR_1", new string[] { "flag", "MltVoucherTx_ID", "MltVoucherTx_IDNotin", "B2BType" }, new string[] { "6", MltVoucherTx_ID, MltVoucherTx_IDNotin, "B2BType" }, "dataset");
                if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
                {
                    btnBack.Visible = false;
                    DivTable.Visible = false;
    ...
    protected void FILLDayBook(string MltVoucherTx_ID, string MltVoucherTx_IDNotin, string GSTRate)
    {
        try
        {
            ...
            if (txtFromDate.Text != "" && txtToDate.Text != "")
            {
                ...
                // lblDateRange.Text = txtFromDate.Text + " to " + txtToDate.Text;
                ds = objdb.ByProcedure("SpFinRptGSTR_1", new string[] { "flag", "MltVoucherTx_ID", "MltVoucherTx_IDNotin", "GSTRate", "FinancialYear", "Office_ID" },
    ...
    protected void GridHSNSummery_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            ...
            if (e.CommandName == "View")
            {
                ...
                ds = objdb.ByProcedure("SpFinRptGSTR_1", new string[] { "flag", "MltVoucherTx_ID", "MltVoucherTx_IDNotin", "HSN", "Description", "TypeOfSupply", "UQC", "FinancialYear", "Office_ID" },
    ...
    protected void btnAllExcel_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ds = objdb.ByProcedure("SpFinRptGSTR_1", new string[] { "flag", "Office_ID_Mlt", "MltVoucherTx_ID", "MltVoucherTx_IDNotin" },
            ...
            ds = objdb.ByProcedure("SpFinRptGSTR_1", new string[] { "flag", "MltVoucherTx_ID", "MltVoucherTx_IDNotin" }, new string[] { "12", VoucherB2cs, "" }, "dataset");
            if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
            {
                int rowcount = ds.Tables[0].Rows.Count;
