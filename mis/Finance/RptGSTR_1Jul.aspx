<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RptGSTR_1Jul.aspx.cs" Inherits="mis_Finance_RptGSTR_1Jul" %>
                                ...
                                <div class="hide_print">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" style="margin-bottom: 0px;">
                                            <tr>
                                                <th style="background-color: #90add2 !important; width: 15%;">SGST</th>
                                                <th>
                                                    <asp:Label ID="lblSGST" runat="server" Text=""></asp:Label>
                                                </th>
                                                <th style="background-color: #90add2 !important; width: 15%;">CGST</th>
                                                <th>
                                                    <asp:Label ID="lblCGST" runat="server" Text=""></asp:Label>
                                                </th>
                                                <th style="background-color: #90add2 !important; width: 15%;">IGST</th>
                                                <th>
                                                    ...
                                                    <td valign="Top" width="100%">
                                                        <table cellspacing="0" cellpadding="0" border="0" width="100%" height="20">
                                                            <tr>
                                                                ...
                                                                <td width="2">&#160;</td>
                                                                <td width="3">&#160;  </td>
                                                                <td valign="Bottom" style="color: #000000; font: 9pt 'Arial';" width="110" align="Left">23AACCM0330Q1ZM
                                                                </td>
...
9pt 'Arial';"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <asp:GridView ID="GridRateWise" runat="server" AutoGenerateColumns="false" class="table table-hover table-bordered" OnRowCommand="GridRateWise_RowCommand">
                                    <Columns>
                                ...
                                <asp:GridView ID="GridView1" DataKeyNames="VoucherTx_ID" runat="server" AutoGenerateColumns="false" class="table table-hover table-bordered">
                                    <Columns>
                                        <asp:TemplateField HeaderText="SNo." ItemStyle-Width="5%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblRowNumber" Text='<%# Container.DataItemIndex + 1 %>' runat="server" />
