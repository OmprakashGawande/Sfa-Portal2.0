...
public partial class mis_Finance_RptGSTR_2 : System.Web.UI.Page
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (txtFromDate.Text != "" && txtToDate.Text != "" && Office != "")
            {
                ...
                ds = objdb.ByProcedure("SpFinRptGSTR_2_New", new string[] { "flag", "Office_ID_Mlt", "FromDate", "ToDate" }, new string[] { "1", Office, Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd") }, "dataset");
                if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
                {
                    // START TOP SECTION
                    DivTable.Visible = true;
    ...
    protected void FILL_Statstics(string VoucherList, string MltVoucherTx_IDNotin)
    {
        try
        {
            ...
            ds = objdb.ByProcedure("SpFinRptGSTR_2_New", new string[] { "flag", "MIncludedRet", "MltVoucherTx_IDNotin" }, new string[] { "11", VoucherList, MltVoucherTx_IDNotin }, "dataset");
            if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
            {
    ...
    protected void Get_HSN_Summary()
    {
        try
        {
            ...
            {
                ds = objdb.ByProcedure("SpFinRptGSTR_2_New", new string[] { "flag", "MltVoucherTx_ID", "MltVoucherTx_IDNotin" }, new string[] { "13", ViewState["MIncludedRet"].ToString(), "" }, "dataset");
                if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
                {
    ...
    protected void btnHSNSummary_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (txtFromDate.Text != "" && txtToDate.Text != "")
            {
                ds = objdb.ByProcedure("SpFinRptGSTR_2_New", new string[] { "flag", "MltVoucherTx_ID", "MltVoucherTx_IDNotin" }, new string[] { "9", ViewState["MIncludedRet"].ToString(), "" }, "dataset");
                if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
                {
    ...
    protected void FILLStatsticsDayBook(string MltVoucherTx_ID, string VoucherTx_Type, string MltVoucherTx_IDNotin)
    {
        try
        {
            ...
            if (txtFromDate.Text != "" && txtToDate.Text != "")
            {
                ...
                // lblDateRange.Text = txtFromDate.Text + " to " + txtToDate.Text;
                ds = objdb.ByProcedure("SpFinRptGSTR_2_New",
    ...
    protected void GridHSNSummery_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            ...
            if (e.CommandName == "View")
            {
                ...
                ds = objdb.ByProcedure("SpFinRptGSTR_2_New", new string[] { "flag", "MltVoucherTx_ID", "MltVoucherTx_IDNotin", "HSN", "Description", "TypeOfSupply", "UQC", "FinancialYear", "Office_ID" },
    ...
    protected void FILLGRID(string MltVoucherTx_ID, string MltVoucherTx_IDNotin)
    {
        try
        {
            ...
            {
                lblDateRange.Text = txtFromDate.Text + " to " + txtToDate.Text;
                ds = objdb.ByProcedure("SpFinRptGSTR_2_New", new string[] { "flag", "MltVoucherTx_ID", "MltVoucherTx_IDNotin" }, new string[] { "2", MltVoucherTx_ID, MltVoucherTx_IDNotin }, "dataset");
                if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
                {
    ...
    protected void FILLRateWiseVoucher(string MltVoucherTx_ID, string MltVoucherTx_IDNotin)
    {
        try
        {
            ...
            {
                //lblDateRange.Text = txtFromDate.Text + " to " + txtToDate.Text;
                ds = objdb.ByProcedure("SpFinRptGSTR_2_New", new string[] { "flag", "MltVoucherTx_ID", "MltVoucherTx_IDNotin" }, new string[] { "6", MltVoucherTx_ID, MltVoucherTx_IDNotin }, "dataset");
                if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
                {
                    btnBack.Visible = false;
                    DivTable.Visible = false;
    ...
    protected void btnAllExcel_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ds = objdb.ByProcedure("SpFinRptGSTR_2_New", new string[] { "flag", "MltVoucherTx_ID", "MltVoucherTx_IDNotin" }, new string[] { "14", ViewState["B2BMltVCount"].ToString(), "" }, "dataset");
            if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
            {
            ...
            ds = objdb.ByProcedure("SpFinRptGSTR_2_New", new string[] { "flag", "MltVoucherTx_ID", "MltVoucherTx_IDNotin" }, new string[] { "14", ViewState["B2BURMltVCount"].ToString(), "" }, "dataset");
            if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
            {
                int rowcount = ds.Tables[0].Rows.Count;
            ...
            ds = objdb.ByProcedure("SpFinRptGSTR_2_New", new string[] { "flag", "MltVoucherTx_ID", "MltVoucherTx_IDNotin" }, new string[] { "14", ViewState["B2B_RevMltVCount"].ToString(), "" }, "dataset");
            if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
            {
                int rowcount = ds.Tables[0].Rows.Count;
            ...
            ds = objdb.ByProcedure("SpFinRptGSTR_2_New", new string[] { "flag", "MltVoucherTx_ID", "MltVoucherTx_IDNotin" }, new string[] { "14", ViewState["B2BUR_RevMltVCount"].ToString(), "" }, "dataset");
            if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
            {
                int rowcount = ds.Tables[0].Rows.Count;
            ...
            ds = objdb.ByProcedure("SpFinRptGSTR_2_New", new string[] { "flag", "MltVoucherTx_ID", "MltVoucherTx_IDNotin", "PlaceofSupply" }, new string[] { "15", ViewState["MNltVCount"].ToString(), "", "INTRA" }, "dataset");
            if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
            {
                int rowcount = ds.Tables[0].Rows.Count;
            ...
            ds = objdb.ByProcedure("SpFinRptGSTR_2_New", new string[] { "flag", "MltVoucherTx_ID", "MltVoucherTx_IDNotin", "PlaceofSupply" }, new string[] { "15", ViewState["MNltVCount"].ToString(), "", "INTER" }, "dataset");
            if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
            {
                int rowcount = ds.Tables[0].Rows.Count;
