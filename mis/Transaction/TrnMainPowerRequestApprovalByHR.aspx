<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="TrnMainPowerRequestApprovalByHR.aspx.cs" Inherits="mis_Transaction_TrnMainPowerRequestApprovalByHR" %>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row" style="padding: 0px 9px 2px 15px;" id="div1" runat="server">
                                        <div>
                                            <h4 style="margin-left: 2rem;">MEN POWER REQUEST APPROVE DETAIL </h4>
                                        </div>
                                                ...
                                                <asp:GridView ID="Grid" PageSize="50" runat="server" class="datatable  table table-hover table-bordered pagination-ys" ShowHeaderWhenEmpty="false" AutoGenerateColumns="False">
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="REQUESTED PROJECT NAME ">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblRequestedProjectName" Text='<%# Eval("RequestProjectName").ToString() %>' runat="server" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
